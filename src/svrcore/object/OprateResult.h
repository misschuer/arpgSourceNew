...
enum ECharOprateType
{
	...
	OPRATE_TYPE_GROUP					= 37,		//组队相关的
	OPRATE_TYPE_GIFTCODE				= 38,		//兑换码相关的
};
...
enum RECEIVE_GIFT_PACKS_OPEATE_RESULT
{
	...
	RECEIVE_GIFT_PACKS_FIRST_RECHARGE_GIFT	= 7,		//首充礼包显示用
	RECEIVE_GIFT_PACKS_DAY_RECHARGE_GIFT	= 8,		//每日充礼包显示用
};
...
enum FACTION_OPERTE_RESULT
{
	...
	OPERTE_TYPE_FACTION_MATCH_DECIDE_FIRST			= 68, //家族战第一轮对阵表已产生
	OPERTE_TYPE_FACTION_MATCH_OPEN_FIRST			= 69, //家族战第一轮比赛开放进入,参赛家族成员请及时进入战场
	OPERTE_TYPE_FACTION_MATCH_START_FIRST			= 70, //家族战第一轮比赛正式开战
	OPERTE_TYPE_FACTION_MATCH_DECIDE_SECOND			= 71, //家族战第二轮对阵表已产生
	OPERTE_TYPE_FACTION_MATCH_OPEN_SECOND			= 72, //家族战第二轮比赛开放进入,参赛家族成员请及时进入战场
	OPERTE_TYPE_FACTION_MATCH_START_SECOND			= 73, //家族战第二轮比赛正式开战
	OPERTE_TYPE_FACTION_MATCH_FINISH				= 74, //恭喜家族 {1} 成为家族战盟主
	OPERTE_TYPE_FACTION_MATCH_CANNOT_JOIN			= 75, //不能加入家族
	OPERTE_TYPE_FACTION_STORE_IS_FULL				= 76, //家族商店已满
};
...
enum NEED_NOTICE_TYPE
{
	...
	NEED_NOTICE_TYPE_REFINE_LVUP		= 11,		//精炼达到X级
	NEED_NOTICE_TYPE_GEM_LVUP		= 12,			//宝石达到X级
	NEED_NOTICE_TYPE_3V3_RANKUP			= 13,		//3v3排行达到1~10

	NEED_NOTICE_TYPE_RECHARGE_LOTTERY	= 14,		//{1}投资{2}元宝获得{3}绑定元宝
};

enum GROUP_NOTICE_TYPE
{
	GROUP_NOTICE_TYPE_MEMBER_IN_INSTANCE = 1,		//{1}正在副本中
	GROUP_NOTICE_TYPE_MEMBER_DECLINE	 = 2,		//{1}拒绝加入
	GROUP_NOTICE_TYPE_MEMBER_NO_TIMES	 = 3,		//{1}次数不足
	GROUP_NOTICE_TYPE_MEMBER_IS_OFFLINE	 = 4,		//{1}已经下线
	GROUP_NOTICE_TYPE_PLAYER_IS_OFFLINE	 = 5,		//提示处于离线无法加入
	GROUP_NOTICE_TYPE_DENIED_JOIN_REQUEST= 6,		//{1}拒绝申请消息
	GROUP_NOTICE_TYPE_KICKED			 = 7,		//被{1}踢消息
	GROUP_NOTICE_TYPE_BECOME_CAPTAIN	 = 8,		//成为队长消息
	GROUP_NOTICE_TYPE_DENIED_INVITE		 = 9,		//{1}拒绝邀请消息
	GROUP_NOTICE_TYPE_MEMBER_FULL		 = 10,		//{1}队伍已满
	GROUP_NOTICE_TYPE_ALREADY_HAVE_GROUP		 = 11,		//{1}对方处于组队状态
	GROUP_NOTICE_TYPE_JOIN_SUCCESS		 = 12,		//{1}加入成功
	GROUP_NOTICE_TYPE_JOIN_REQUEST		 = 13,		//{1}请求已发送
	GROUP_NOTICE_TYPE_GROUP_NOT_EXIST		 = 14,		//{1}队伍不存在


};

enum GIFTCODE_NOTICE_TYPE
{
	GIFTCODE_NOTICE_TYPE_INVALID = 1,		//无效兑换码
	GIFTCODE_NOTICE_TYPE_USED = 2,			//该兑换码已经被使用过了
	GIFTCODE_NOTICE_TYPE_ALREADY_GET = 3,	//已兑换过该类型礼包
	GIFTCODE_NOTICE_TYPE_SUCCESS = 4,		//兑换成功
