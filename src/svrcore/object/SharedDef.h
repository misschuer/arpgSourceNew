...
{	
	...
	UNIT_FIELD_ATTRIBUTE_END				= UNIT_FIELD_DAO + 1,	// 属性结束
	...
	UNIT_FIELD_ATTRIBUTE_BASE_END			= UNIT_FIELD_DAO_BASE + 1,	// 属性结束
...
enum EPlayerFields
{
	...
	PLAYER_FIELD_ATTR_RESERVE0			=	 PLAYER_FIELD_DAO + 2,				//预留属性0
...
#define MAX_GROUP_MEMBER_COUNT 5

enum EGroupMemberInfo
{
	GROUP_MEMBER_INT_LEVEL		= 0,	//队员信息
...
enum EGroupFields
{
	GROUP_INT_FIELD_MEMBER_INFO_START = 0,
