...
class SharedDef
	{
		...
		public static MAX_MONEY_CHANGE_TYPE			:number = 130;
		// 特殊包裹类型
		...
		public static MAX_EQUIP_ATTR			:number = 33;
		// 物品其他属性枚举（物品特殊属性接在MAX_EQUIP_ATTR后面）
		public static ITEM_OTHER_ATTR_FAIL_TIME			:number = 33;	// 失效时间
		public static ITEM_OTHER_ATTR_STRONG_LV			:number = 34;	// 强化等级
		public static ITEM_OTHER_ATTR_STRONG_FAIL_COUNT			:number = 35;	// 强化失败次数
		public static ITEM_OTHER_ATTR_FORCE			:number = 36;	// 战斗力
		// 技能族公共CD类型
		...
		public static UNIT_FIELD_ATTRIBUTE_END			:number = 120;	//  属性结束
		public static UNIT_FIELD_MAX_HEALTH_BASE			:number = 120;	// 最大生命
		public static UNIT_FIELD_DAMAGE_BASE			:number = 121;	// 攻击力
		public static UNIT_FIELD_ARMOR_BASE			:number = 122;	// 防御力
		public static UNIT_FIELD_HIT_BASE			:number = 123;	// 命中
		public static UNIT_FIELD_MISS_BASE			:number = 124;	// 闪避
		public static UNIT_FIELD_CRIT_BASE			:number = 125;	// 暴击
		public static UNIT_FIELD_TOUGH_BASE			:number = 126;	// 坚韧
		public static UNIT_FIELD_ATTACK_SPEED_BASE			:number = 127;	// 攻击速度
		public static UNIT_FIELD_MOVE_SPEED_BASE			:number = 128;	// 移动速度
		public static UNIT_FIELD_IGNORE_ARMOR_BASE			:number = 129;	// 忽视防御
		public static UNIT_FIELD_IGNORE_MISS_BASE			:number = 130;	// 忽视闪避
		public static UNIT_FIELD_RECOVERY_BASE			:number = 131;	// 生命值回复
		public static UNIT_FIELD_DAMAGE_AMPLIFY_RATE_BASE			:number = 132;	// 伤害加深(万分比)
		public static UNIT_FIELD_DAMAGE_RESIST_RATE_BASE			:number = 133;	// 伤害减免(万分比)
		public static UNIT_FIELD_DAMAGE_RETURN_RATE_BASE			:number = 134;	// 反弹伤害(万分比)
		public static UNIT_FIELD_VAMPIRIC_RATE_BASE			:number = 135;	// 吸血光环(万分比)
		public static UNIT_FIELD_RECOVERY_RATE_BASE			:number = 136;	// 回复效率(万分比)
		public static UNIT_FIELD_CRIT_RATE_BASE			:number = 137;	// 暴击率(万分比)
		public static UNIT_FIELD_CRIT_RESIST_RATE_BASE			:number = 138;	// 抗暴率(万分比)
		public static UNIT_FIELD_CRIT_DAM_RATE_BASE			:number = 139;	// 暴击伤害倍数(万分比)
		public static UNIT_FIELD_CRIT_RESIST_DAM_RATE_BASE			:number = 140;	// 降暴伤害倍数(万分比)
		public static UNIT_FIELD_HIT_RATE_BASE			:number = 141;	// 命中率(万分比)
		public static UNIT_FIELD_MISS_RATE_BASE			:number = 142;	// 闪避率(万分比)
		public static UNIT_FIELD_STUN_RATE_BASE			:number = 143;	// 眩晕
		public static UNIT_FIELD_ROOTS_RATE_BASE			:number = 144;	// 定身
		public static UNIT_FIELD_SILENCE_RATE_BASE			:number = 145;	// 沉默
		public static UNIT_FIELD_CHAOS_RATE_BASE			:number = 146;	// 混乱
		public static UNIT_FIELD_CHARM_RATE_BASE			:number = 147;	// 魅惑
		public static UNIT_FIELD_CONTROL_ENHANCE_RATE_BASE			:number = 148;	// 控制增强
		public static UNIT_FIELD_CONTROL_RESIST_RATE_BASE			:number = 149;	// 控制减免
		public static UNIT_FIELD_STRENGTH_ARMOR_BASE			:number = 150;	// 强化护甲
		public static UNIT_FIELD_DAO_BASE			:number = 151;	//  境界
		public static UNIT_FIELD_ATTRIBUTE_BASE_END			:number = 152;	//  属性结束
		public static UNIT_FIELD_ANGER			:number = 152;	// 愤怒值
		public static UNIT_FIELD_USE_RESPAWN_MAPID			:number = 153;	// 使用复活丹的地图id
		public static UNIT_FIELD_PROCESS_TIME			:number = 154;	//  进度条读完的时间戳
		public static UNIT_FIELD_PROCESS_SECONDS			:number = 155;	//  读条总共需要时间	
		public static UINT_FIELD_BOSS_DATA			:number = 156;	// boss数据byte 0:boss状态 1:boss前一状态 2:boss索引(云游的是这个用途)
		public static UINT_FIELD_BOSS_DATA1			:number = 157;	// boss数据byte 0:当前坐标x 1:当前坐标y 2:下一坐标x 3:下一坐标y(云游的是这个用途)
		public static UINT_FIELD_VIEW_MODE			:number = 157;	// 是否是观看模式
		public static UINT_FIELD_VIRTUAL_CAMP			:number = 158;	// 虚拟阵营
		public static UINT_FIELD_XIANFU_INFO			:number = 159;	// 跨服仙府的信息4bytes (0:宝箱数量, 1:死亡次数)
		public static UINT_FIELD_VIP_LEVEL			:number = 160;	// VIP等级
		public static UINT_FIELD_VIP_TIME_OUT			:number = 161;	// VIP超时时间
		public static UINT_FIELD_VAMPIRIC			:number = 162;	// 当前战斗的吸血值
		public static UINT_INT_FIELD_ILLUSION			:number = 164;	// 角色幻化
		public static UINT_FIELD_BOOS_CUR_SPELLID			:number = 165;	// 当前正在释放的蓄力技能idUNIT_INT_FIELD_APPEARANCE
		public static UINT_FIELD_BOOS_CUR_SPELL_TIME			:number = 166;	// 前一个技能结束的时间戳
		public static UINT_FIELD_BOOS_CUR_SPELL_LAST_COUNT			:number = 167;	//  持续技能数量
		public static UINT_INT_FIELD_PASSIVE_SPELL_START			:number = 168;	// 被动技能开始
		public static UINT_INT_FIELD_PASSIVE_SPELL_END			:number = 268;	// 被动技能结束
		public static UINT_INT_FIELD_WINGS_RANK			:number = 268;	// 神羽阶数
		public static UNIT_INT_FIELD_APPEARANCE			:number = 269;	//  外观
		public static UNIT_INT_FIELD_RISK_CREATURE_ID			:number = 270;	//  世界冒险怪物对应的序号
		public static UNIT_INT_FIELD_OPERATE_CD			:number = 271;	// 场景服操作冷却
		public static MAX_UNIT_FIELD			:number = 272;
		...
		public static PLAYER_FIELD_ATTR_RESERVE0			:number = 81;	// 预留属性0
		public static PLAYER_FIELD_ATTR_RESERVE1			:number = 83;	// 预留属性1
		public static PLAYER_FIELD_ATTR_RESERVE2			:number = 85;	// 预留属性2
		public static PLAYER_FIELD_ATTR_RESERVE3			:number = 87;	// 预留属性3
		public static PLAYER_FIELD_ATTR_RESERVE4			:number = 89;	// 预留属性4
		public static PLAYER_FIELD_ATTR_RESERVE5			:number = 91;	// 预留属性5
		public static PLAYER_FIELD_ATTR_RESERVE6			:number = 93;	// 预留属性6
		public static PLAYER_FIELD_ATTR_RESERVE7			:number = 95;	// 预留属性7
		public static PLAYER_FIELD_BUFF			:number = 97;	// BUFF
		public static PLAYER_FIELD_BUFF_RESERVE			:number = 147;	// BUFF保留参数	
		public static PLAYER_INT_FIELD_BUFF_GIVER_UINT_GUID			:number = 197;	// buff giver的uintGuid
		public static PLAYER_INT_FIELD_BUFF_EFFECT_ID_START			:number = 247;	// buff等级 (byte)
		public static PLAYER_INT_FIELD_BUFF_EFFECT_ID_END			:number = 297;
		public static PLAYER_FIELD_SKIN			:number = 297;	// 生物变身
		public static PLAYER_FIELD_BYTES_1			:number = 298;	// 四个字节,分别存放 0怪物分类
		public static PLAYER_FIELD_FORCE			:number = 299;	// 战斗力
		public static PLAYER_FIELD_EQUIPMENT			:number = 301;	// 装备列表，12个32位预留三个
		public static PLAYER_FIELD_CUR_MOUNT			:number = 321;	// 当前坐骑模板id
		public static PLAYER_FIELD_PEACE_MODE_CD			:number = 322;	// 和平模式CD
		public static PLAYER_FIELD_NOTORIETY			:number = 323;	// 2个short(0:战斗模式, 1:恶名值)
		public static PLAYER_FIELD_BYTES_2			:number = 324;	// 玩家标识,存4个byte[0灰名时间 1付费等级 2免费复活 3玩家称号]
		public static PLAYER_FIELD_BYTES_3			:number = 325;	// 四个字节,分别存放 0头像,[1发型2可用技能槽数量3下次复活是否有保护buff]
		public static PLAYER_FIELD_BYTES_4			:number = 326;	// 四个字节,分别存放 (0:频道屏蔽列表,1:预留,2:预留,3:预留)
		public static PLAYER_FIELD_BYTES_5			:number = 327;	// 0 GM权限, 1, 2 
		public static PLAYER_FIELD_AUTO_HP			:number = 328;	// 大红
		public static PLAYER_FIELD_AUTO_MP			:number = 330;	// 大蓝
		public static PLAYER_FIELD_VIP_LEVEL			:number = 332;	// VIP 等级
		public static PLAYER_FIELD_VIP_TIME_OUT			:number = 333;	// VIP 超时时间
		//  挂机设置
		public static PLAYER_FIELD_HOOK			:number = 334;	// 挂机状态
		public static PLAYER_FIELD_HOOK_BYTE0			:number = 335;	// 0:槽1技能,1:槽2技能,2:槽3技能,3:槽4技能
		public static PLAYER_FIELD_HOOK_BYTE1			:number = 336;	// 0:神兵技能,1:怒气技能2:使用银两买药,3:银两不足用元宝买药
		public static PLAYER_FIELD_HOOK_SHORT			:number = 337;	// 0:自动吃药百分比,1:自动使用道具id
		public static PLAYER_FIELD_HOOK_BYTE3			:number = 338;	// 0:回程复活/原地复活,1:自动使用绑银购买复活丹,2:绑银不足用元宝,3:自动出售某种平直及以下装备
		public static PLAYER_FIELD_FLAGS			:number = 339;	// 主玩家下标flags
		public static PLAYER_FIELD_FLAGS_END			:number = 347;	// 预留8个32位flags
		public static PLAYER_FIELD_ONLINE_TIME			:number = 347;	// 总在线时长(分钟为单位)
		public static PLAYER_FIELD_ANGER			:number = 348;	// 怒气改变
		public static PLAYER_FIELD_TRIAL_LAYERS			:number = 349;
		public static PLAYER_INT_FIELD_TRIAL_FINISHED_SECTIONID			:number = 350;	// (已经通关的关卡id)
		public static PLAYER_INT_FIELD_TRIAL_PROCESS			:number = 351;	// (0:已经杀的怪,1:总共需要杀的怪)
		public static PLAYER_FIELD_DECLINE_CHANNEL_BYTE0			:number = 352;	// 拒绝频道A(0系统，1帮派，2组队，3世界)
		public static PLAYER_FIELD_DECLINE_CHANNEL_BYTE1			:number = 353;	// 拒绝频道B(0:附近)
		public static PLAYER_SCENED_INT_FIELD_PLAYER_JUMP_CD			:number = 354;	// 跳跃CD
		public static PLAYER_INT_FIELD_SYSTEM_MAIL_ID			:number = 355;	// 当前领取的系统邮件的id
		public static PLAYER_FIELD_DIVINE_NUM			:number = 356;	// 神兵数量
		public static PLAYER_FIELD_DIVINE_FORCE			:number = 357;	// 神兵总战斗力
		public static PLAYER_FIELD_MOUNT_FORCE			:number = 358;	// 坐骑总战力
		public static PLAYER_FIELD_SKILL_FORCE			:number = 359;	// 技能战力
		public static PLAYER_FILED_GEM_FORCE			:number = 360;	// 宝石战力
		public static PLAYER_FIELD_STRENGTH_FORCE			:number = 361;	// 强化战力
		public static PLAYER_FIELD_RANK_LIKE			:number = 362;
		public static PLAYER_FIELD_USE_RANK_LIKE			:number = 363;
		public static PLAYER_FIELD_SHOP_LIMIT_START			:number = 364;
		public static PLAYER_FIELD_SHOP_LIMIT_END			:number = 384;
		public static PLAYER_EXPAND_INT_FCM_LOGIN_TIME			:number = 384;	// 防沉迷，单位：分钟	-1是非防沉迷玩家
		public static PLAYER_EXPAND_INT_FCM_LOGOUT_TIME			:number = 385;	// 防沉迷离线时间
		public static PLAYER_EXPAND_INT_CREATE_TIME			:number = 386;	// 角色创建时间
		public static PLAYER_EXPAND_INT_LAST_LOGIN_TIME			:number = 387;	// 最后登录时间
		public static PLAYER_EXPAND_INT_LAST_LOGOUT_TIME			:number = 388;	// 最后离线时间
		public static PLAYER_EXPAND_INT_NUMBER_OF_LOGINS			:number = 389;	// 累积登录次数
		public static PLAYER_EXPAND_INT_MONEY			:number = 390;	// 各种货币
		public static PLAYER_EXPAND_INT_MONEY_END			:number = 434;
		public static PLAYER_EXPAND_INT_USE_FASHION			:number = 434;	// 是否启用时装,目前用到20个pos
		public static PLAYER_EXPAND_INT_XP			:number = 435;	// 当前经验，64位
		public static PLAYER_EXPAND_INT_NEXT_LEVEL_XP			:number = 437;	// 下一级经验，64位
		public static PLAYER_EXPAND_INT_XP_ADDED			:number = 439;	//  应用服增加的经验
		public static PLAYER_EXPAND_INT_XP_PICKED			:number = 441;	//  场景服已经领取的应用服增加的经验
		public static PLAYER_EXPAND_INT_MAP_STATUS			:number = 443;	//  地图开启进度
		public static PLAYER_EXPAND_INT_GAG_END_TIME			:number = 444;	// 禁言结束时间
		public static PLAYER_EXPAND_INT_TO_MAP			:number = 445;	// 玩家要传送到的地图
		public static PLAYER_EXPAND_INT_TO_INSTANCE_ID			:number = 446;	// 玩家要传送到的地图实例ID
		public static PLAYER_EXPAND_INT_TO_POS_X			:number = 447;	// 玩家药传送到的坐标
		public static PLAYER_EXPAND_INT_TO_POS_Y			:number = 448;
		public static PLAYER_EXPAND_INT_TO_LINE_NO			:number = 449;	// 传送线号
		public static PLAYER_EXPAND_INT_DB_MAP			:number = 450;	// 玩家最后一次进入副本前的地图	
		public static PLAYER_EXPAND_INT_DB_POS_X			:number = 451;	// 玩家最后一次进入副本前的坐标
		public static PLAYER_EXPAND_INT_DB_POS_Y			:number = 452;
		public static PLAYER_EXPAND_INT_CLIENT_DATA			:number = 453;	// 远程存储
		// ////////////////////////////////////////////////////////////////////////
		// 应用服部分	
		public static PLAYER_APPD_INT_FIELD_FLAG			:number = 553;	// 玩家标志位
		public static PLAYER_APPD_INT_FIELD_FLAG_END			:number = 560;	// 结束下标
		public static PLAYER_APPD_INT_FIELD_DAILY_TIME			:number = 560;	//  每天在线时长（min）
		public static PLAYER_APPD_INT_FIELD_RESET_WEEK			:number = 561;	//  每周重置时间
		public static PLAYER_APPD_INT_FIELD_RESET_DALIY			:number = 562;	// 重置的时间点每小时一次
		public static PLAYER_APPD_INT_FIELD_RECHARGE_SUM			:number = 586;	// 累计充值总数
		public static PLAYER_APPD_INT_FIELD_LAST_RECHARGE_TIME			:number = 587;	// 最后一笔充值时间
		public static PLAYER_APPD_INT_FLELD_JHM_FLAGS			:number = 588;	// 激活码flags
		public static PLAYER_APPD_INT_FLELD_JHM_FLAGS_END			:number = 596;	// 激活码flags_end
		// 主背包扩展时间戳
		public static PLAYER_APPD_INT_FIELD_EXTENSION_END_TIME			:number = 597;	// 主包裹扩展结束时间戳
		public static PLAYER_APPD_INT_FIELD_EXTENSION_REMAIN_TIME			:number = 598;	// 主包裹扩展剩余多少时间
		public static PLAYER_INT_FIELD_BLOCK_COUNT			:number = 600;	// 屏蔽列表个数
		public static PLAYER_INT_FIELD_WORLD_BOSS_JOIN_ID			:number = 601;	// 最后一次参加的世界BOSS id
		public static PLAYER_INT_FIELD_WORLD_BOSS_JOIN_STATE			:number = 602;	// 0:最后一次参加的世界BOSS状态, 1:进入的线数,2:死亡次数,3:预留
		// 场景服扩展下标开始了
		public static PLAYER_SCENED_INT_FLAGS			:number = 603;	// 玩家场景服标志位
		//  只显示装备的主动技能
		public static PLAYER_INT_FIELD_SPELL_START			:number = 611;
		public static PLAYER_INT_FIELD_SPELL_END			:number = 623;
		// 重要技能的CD
		public static PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_START			:number = 623;
		public static PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_END			:number = 663;
		public static PLAYER_EXPAND_KILL_MONSTER			:number = 663;	// 杀怪数
		// 跨服
		public static PLAYER_APPD_INT_FIELD_KUAFU_WARID			:number = 664;	// 跨服场次id
		public static PLAYER_INT_FIELD_KUAFU_NUMBER			:number = 665;	// 0:玩家报名跨服时收到匹配信息中给的编号 1:跨服类型（值参照枚举：EKUAFU_TYPE）
		public static PLAYER_INT_FIELD_MAIN_QUEST_ID			:number = 666;	// 当前主线任务
		public static PLAYER_INT_FIELD_QUEST_CHAPTER			:number = 667;	// 任务章节奖励领取情况
		public static PLAYER_INT_FIELD_MOUNT_LEVEL			:number = 668;	// 4个bytes(0:当前坐骑阶数 1:当前坐骑星级,2:当前坐骑是否骑乘，3:当前幻化id)
		public static PLAYER_INT_FIELD_DIVINE_ID			:number = 669;	// 当前装备的神兵id
		public static PLAYER_INT_FIELD_PASSIVE_SPELL_START			:number = 670;	// 被动技能开始
		public static PLAYER_INT_FIELD_PASSIVE_SPELL_END			:number = 770;	// 被动技能个数
		public static PLAYER_INT_FIELD_VIRTUAL_CAMP			:number = 770;	// 虚拟阵营
		public static PLAYER_INT_FIELD_WORLD_3V3_SCORE			:number = 771;	// 跨服3v3积分
		public static PLAYER_INT_FIELD_WORLD_3V3_TOTAL_SCORE			:number = 772;	// 跨服3v3积分
		public static PLAYER_INT_FIELD_WORLD_3V3_TREND_INFO			:number = 773;	// 胜负走势
		public static PLAYER_INT_FIELD_DOUJIANTAI_RANK			:number = 774;	// 斗剑台排名
		public static PLAYER_INT_FIELD_DOUJIANTAI_REFRESH_TIME			:number = 775;	// 最后一次刷新对手时间戳
		public static PLAYER_INT_FIELD_ARREARS			:number = 776;	// 欠费
		public static PLAYER_INT_FIELD_DAILY_QUEST_FINISHED			:number = 778;	//  每日任务完成数
		public static PLAYER_INT_FIELD_BAG_SORT_TIME			:number = 779;	// 整理背包时间戳
		// 已开启功能的记录
		public static PLAYER_INT_FIELD_OPEN_MENU_INDEX			:number = 780;
		public static PLAYER_INT_FIELD_OPEN_MENU_START			:number = 781;
		public static PLAYER_INT_FIELD_OPEN_MENU_END			:number = 881;
		// 已购家族商店物品的记录
		public static PLAYER_INT_FIELD_BUYED_FACTION_SHOP			:number = 882;	// 已购家族商店物品开始
		public static PLAYER_INT_FIELD_BUYED_FACTION_SHOP_END			:number = 890;	// 已购家族商店物品结束
		// 记录强制引导ID 
		public static PLAYER_INT_FIELD_GUIDE_ID_LAST			:number = 891;	// 上次完成的引导
		public static PLAYER_INT_FIELD_GUIDE_ID_NOW			:number = 892;	// 当前进行中的引导
		// 修炼场相关
		public static PLAYER_INT_FIELD_CULTIVATION_LAST_PLUNDER_TIME			:number = 893;	// 上次挑战时间戳
		public static PLAYER_INT_FIELD_CULTIVATION_LAST_REFRESH_TIME			:number = 894;	// 上次刷新对手时间戳
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_EXP			:number = 895;	// 当日累计掠夺经验
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_CHEST			:number = 896;	// 当日累计掠夺宝箱数
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_PURCHASE_COUNT			:number = 897;	// 当日购买次数
		public static PLAYER_INT_FIELD_CULTIVATION_LEFT_PLUNDER_COUNT			:number = 898;	// 当前剩余挑战次数
		public static PLAYER_INT_FIELD_CULTIVATION_PLUNDER_RECORD_INDEX			:number = 899;	// 修练场修炼记录下标
		public static PLAYER_INT_FIELD_CULTIVATION_TOTAL_BEEN_PLUNDER_COUNT			:number = 900;	// 本轮被掠夺成功次数
		public static PLAYER_INT_FIELD_CULTIVATION_TODAY_TOTAL_PLUNDER_COUNT			:number = 901;	// 本日总掠夺次数
		public static PLAYER_INT_FIELD_CULTIVATION_START_TIME			:number = 902;	// 修炼开始时间
		public static PLAYER_INT_FIELD_CULTIVATION_LOST_INFO			:number = 903;	// 修炼宝箱丢失信息
		// 登陆大礼相关
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_TOTAL_DAYS			:number = 904;	// 登陆总天数
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_START			:number = 905;	// 领取状态开始
		public static PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_END			:number = 907;	// 领取状态结束
		//  非强制引导ID
		public static PLAYER_INT_FIELD_OPTIONAL_GUIDE_START			:number = 908;	// 非强制引导开始
		public static PLAYER_INT_FIELD_OPTIONAL_GUIDE_END			:number = 968;	//  非强制引导结束
		public static PLAYER_INT_FILED_LEAVE_RISK_TIME			:number = 968;	// 离开冒险世界的时间戳
		public static PLAYER_INT_FILED_LEAVE_RISK_SUIT_SCORE			:number = 969;	// 是否已经领取不在冒险世界的挂机奖励
		public static PLAYER_INT_FILED_FACTION_BUILDING_SPEEDUP_DAILY_COUNT			:number = 970;	// 家族建筑升级加速每日次数
		public static PLAYER_INT_FILED_FACTION_DONATE_GIFT_EXCHANGE_DAILY_COUNT			:number = 971;	// 家族宝库贡献礼物兑换每日次数
		public static PLAYER_INT_FILED_CHARM_POINT			:number = 972;	// 魅力值
		public static PLAYER_INT_FILED_FACTION_GIFT_NEXT_COUNT_ID			:number = 974;	// 玩家礼物历史记录下一个count_id
		public static PLAYER_INT_FILED_FACTION_GIFT_START			:number = 975;	// 玩家礼物历史记录开始
		public static PLAYER_INT_FILED_FACTION_GIFT_END			:number = 1725;
		public static PLAYER_INT_FIELD_CREATE_ICON			:number = 1725;	// 待创建的帮派icon
		public static PLAYER_INT_FIELD_FACTION_GIFT_POINT_COUNT			:number = 1726;	// 帮派魅力赠送总记数
		public static PLAYER_INT_FIELD_FACTION_GIFT_SEND_COUNT			:number = 1728;	// 帮派礼物赠送总记数
		public static PLAYER_INT_FIELD_FACTION_GIFT_BEEN_THANK_COUNT			:number = 1729;	// 帮派礼物赠送被女王感谢记数
		public static PLAYER_INT_FIELD_MASS_BOSS_BUYED_TIMES			:number = 1730;	// 已经购买次数
		public static PLAYER_INT_FIELD_MASS_BOSS_TIMES			:number = 1731;	// 全民boss次数
		public static PLAYER_INT_FIELD_MASS_BOSS_CD			:number = 1732;	// 全民boss回复cd(0:表示已满了, 只有次数不满的情况才有cd)
		public static PLAYER_INT_FIELD_TALISMAN_FORCE			:number = 1733;	// 法宝总战力
		public static PLAYER_INT_FIELD_WINGS_FORCE			:number = 1734;	// 神羽总战力
		public static PLAYER_INT_FIELD_GROUP_INSTANCE_CLEAR_FLAG			:number = 1735;	// 组队副本首次通关flag
		public static PLAYER_INT_FIELD_MERIDIAN_FORCE			:number = 1736;	// 经脉修炼战力
		public static PLAYER_INT_FIELD_WINGS_RANK			:number = 1737;	// 神羽阶数
		public static PLAYER_INT_FIELD_FACTION_BOSSDEFENSE_TICKETS			:number = 1738;	// 家族首领挑战剩余次数
		public static PLAYER_INT_FIELD_FACTION_TOWER_CLEAR_FLOOR			:number = 1739;	// 家族无尽远征 历史挑战层数
		public static PLAYER_INT_FIELD_FACTION_TOWER_FLAG			:number = 1740;	// 0 扫荡状态 1~15 宝箱领取状态
		public static PLAYER_INT_FIELD_QUALIFY_SCORE			:number = 1741;	//  排位赛积分
		public static PLAYER_INT_FIELD_FACTION_SKILL_LV_START			:number = 1742;	// 家族技能等级开始 0:已学习等级 uint16 1:当前生效等级
		public static PLAYER_INT_FIELD_FACTION_SKILL_LV_END			:number = 1762;	// 家族技能等级结束
		public static PLAYER_INT_FIELD_APPEARANCE			:number = 1762;	//  外观(0:武器,1:衣服)
		public static PLAYER_INT_FIELD_WEAPON_FORCE			:number = 1763;	//  武器外观战力
		public static PLAYER_INT_FIELD_CLOTH_FORCE			:number = 1764;	//  衣服外观战力
		public static PLAYER_INT_FIELD_POKEDEX_FORCE			:number = 1765;	//  图鉴战力
		public static PLAYER_INT_FIELD_TITLE_FORCE			:number = 1766;	//  称号战力
		public static PLAYER_INT_FIELD_RENAME_TIMES			:number = 1767;	//  改名次数
		public static PLAYER_INT_FIELD_REVENGE_TIMES			:number = 1768;	// 当日剩余复仇次数
		public static PLAYER_INT_FIELD_REVENGE_BUY_TIMES			:number = 1769;	// 当日复仇购买次数
		public static PLAYER_INT_FIELD_WINGS_STAR			:number = 1770;	// 神羽星数
		public static PLAYER_INT_FIELD_VIPGIFT_FLAG			:number = 1771;	// vip礼包购买状态
		public static PLAYER_APPD_INT_FIELD_CONSUME_SUM			:number = 1772;	// 累计消费元宝
		public static PLAYER_APPD_INT_FIELD_MONEYTREE_COUNT			:number = 1773;	// 摇钱树摇钱次数
		public static PLAYER_APPD_INT_FIELD_MONEYTREE_GIFT_FLAG			:number = 1774;	// 摇钱树礼包领取状态
		public static PLAYER_INT_FIELD_WORLD_RISK_LAST_ID			:number = 1775;	// 最后一次进入的幻境地图id
		public static PLAYER_INT_FIELD_LAST_INSTANCE_TYPE			:number = 1776;	// 上次副本子类型
		public static PLAYER_INT_FIELD_LAST_INSTANCE_PARAM			:number = 1777;	// 上次副本额外参数
		public static PLAYER_EXPAND_INT_LAST_IS_RISK			:number = 1778;	// 最后一次进的是幻境
		public static PLAYER_INT_FIELD_RESTORE_POTION_CD			:number = 1779;	// 回复药功能CD
		public static PLAYER_INT_FIELD_ESCORT_ROB_COUNT			:number = 1780;	// 劫镖次数
		public static PLAYER_INT_FIELD_ADVENTURE_ROBOT_KILL_COUNT			:number = 1781;	// 冒险击杀机器人计数
		public static PLAYER_INT_FIELD_REALMBREAK_LEVEL			:number = 1782;	// 境界突破等级
		public static PLAYER_INT_FIELD_REALMBREAK_EXP			:number = 1783;	// 境界突破当前经验
		public static PLAYER_INT_FIELD_REALMBREAK_DAILYQUEST_STATE			:number = 1784;	// 境界突破每日任务 0,uint16完成次数 1,uint16领取状态
		public static PLAYER_INT_FIELD_OPERATE_CD			:number = 1785;	// 所有操作公用CD
		public static PLAYER_INT_FIELD_PASSED_STAGE_INSTANCE_ID			:number = 1786;	// 已通关闯关副本Id
		// ////////////////////////////////////////////////////////////////////////////////////////////////////////
		// 字符串部分
		...
		public static MAX_GROUP_MEMBER_COUNT			:number = 5;
		public static GROUP_MEMBER_INT_LEVEL			:number = 0;	// 队员信息
		public static MAX_GROUP_MEMBER_INFO_INT_COUNT			:number = 1;
		public static GROUP_MEMBER_STR_GUID			:number = 0;	//  玩家guid
		public static MAX_GROUP_MEMBER_INFO_STR_COUNT			:number = 1;
		public static GROUP_INT_FIELD_MEMBER_INFO_START			:number = 0;
		public static GROUP_INT_FIELD_MEMBER_INFO_END			:number = 5;
		public static GROUP_STR_FIELD_MEMBER_INFO_START			:number = 0;
		public static GROUP_STR_FIELD_MEMBER_INFO_END			:number = 5;
		...
		public static INSTANCE_INT_FIELD_STAGE_INSTANCE_BONUS_FLAG_START			:number = 108;	// 闯关宝箱领取状态开始
		public static INSTANCE_INT_FIELD_STAGE_INSTANCE_BONUS_FLAG_END			:number = 118;	// 闯关宝箱领取状态结束
		...
		public static STAGE_INSTANCE_BUFF_ID			:number = 44;	// 闯关副本场景buffid
		// 世界冒险
