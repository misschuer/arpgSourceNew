QUEST_UPDATE_CALLBACK = {
	...
	[QUEST_TARGET_TYPE_REALMBREAK_LEVEL]	= IQuestRealmbreakLevel,
	[QUEST_TARGET_TYPE_INSTANCE_EXP_TIMES]	= IQuestInstanceExpTimes,
	[QUEST_TARGET_TYPE_INSTANCE_GROUP_TIMES]	= IQuestInstanceGroupTimes,
	[QUEST_TARGET_TYPE_EQUIPDEVELOP_REFINE_MULTI_LEVEL]	= IQuestEquipdevelopRefineMultiLevel,
	[QUEST_TARGET_TYPE_VIP_LEVEL]	= IQuestVIPLevel,
