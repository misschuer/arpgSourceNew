...
ITEM_OTHER_ATTR_FAIL_TIME = 33	-- 失效时间
ITEM_OTHER_ATTR_STRONG_LV = 34	-- 强化等级
ITEM_OTHER_ATTR_STRONG_FAIL_COUNT = 35	-- 强化失败次数
ITEM_OTHER_ATTR_FORCE = 36	-- 战斗力
-- 技能族公共CD类型
SPELL_CD_BASE = 0
SPELL_CD_SPECIAL = 1
MAX_SPELL_CD_TYPE = 2
...
UNIT_FIELD_ATTRIBUTE_END = 120	--  属性结束
UNIT_FIELD_MAX_HEALTH_BASE = 120	-- 最大生命
UNIT_FIELD_DAMAGE_BASE = 121	-- 攻击力
UNIT_FIELD_ARMOR_BASE = 122	-- 防御力
UNIT_FIELD_HIT_BASE = 123	-- 命中
UNIT_FIELD_MISS_BASE = 124	-- 闪避
UNIT_FIELD_CRIT_BASE = 125	-- 暴击
UNIT_FIELD_TOUGH_BASE = 126	-- 坚韧
UNIT_FIELD_ATTACK_SPEED_BASE = 127	-- 攻击速度
UNIT_FIELD_MOVE_SPEED_BASE = 128	-- 移动速度
UNIT_FIELD_IGNORE_ARMOR_BASE = 129	-- 忽视防御
UNIT_FIELD_IGNORE_MISS_BASE = 130	-- 忽视闪避
UNIT_FIELD_RECOVERY_BASE = 131	-- 生命值回复
UNIT_FIELD_DAMAGE_AMPLIFY_RATE_BASE = 132	-- 伤害加深(万分比)
UNIT_FIELD_DAMAGE_RESIST_RATE_BASE = 133	-- 伤害减免(万分比)
UNIT_FIELD_DAMAGE_RETURN_RATE_BASE = 134	-- 反弹伤害(万分比)
UNIT_FIELD_VAMPIRIC_RATE_BASE = 135	-- 吸血光环(万分比)
UNIT_FIELD_RECOVERY_RATE_BASE = 136	-- 回复效率(万分比)
UNIT_FIELD_CRIT_RATE_BASE = 137	-- 暴击率(万分比)
UNIT_FIELD_CRIT_RESIST_RATE_BASE = 138	-- 抗暴率(万分比)
UNIT_FIELD_CRIT_DAM_RATE_BASE = 139	-- 暴击伤害倍数(万分比)
UNIT_FIELD_CRIT_RESIST_DAM_RATE_BASE = 140	-- 降暴伤害倍数(万分比)
UNIT_FIELD_HIT_RATE_BASE = 141	-- 命中率(万分比)
UNIT_FIELD_MISS_RATE_BASE = 142	-- 闪避率(万分比)
UNIT_FIELD_STUN_RATE_BASE = 143	-- 眩晕
UNIT_FIELD_ROOTS_RATE_BASE = 144	-- 定身
UNIT_FIELD_SILENCE_RATE_BASE = 145	-- 沉默
UNIT_FIELD_CHAOS_RATE_BASE = 146	-- 混乱
UNIT_FIELD_CHARM_RATE_BASE = 147	-- 魅惑
UNIT_FIELD_CONTROL_ENHANCE_RATE_BASE = 148	-- 控制增强
UNIT_FIELD_CONTROL_RESIST_RATE_BASE = 149	-- 控制减免
UNIT_FIELD_STRENGTH_ARMOR_BASE = 150	-- 强化护甲
UNIT_FIELD_DAO_BASE = 151	--  境界
UNIT_FIELD_ATTRIBUTE_BASE_END = 152	--  属性结束
UNIT_FIELD_ANGER = 152	-- 愤怒值
UNIT_FIELD_USE_RESPAWN_MAPID = 153	-- 使用复活丹的地图id
UNIT_FIELD_PROCESS_TIME = 154	--  进度条读完的时间戳
UNIT_FIELD_PROCESS_SECONDS = 155	--  读条总共需要时间	
UINT_FIELD_BOSS_DATA = 156	-- boss数据byte 0:boss状态 1:boss前一状态 2:boss索引(云游的是这个用途)
UINT_FIELD_BOSS_DATA1 = 157	-- boss数据byte 0:当前坐标x 1:当前坐标y 2:下一坐标x 3:下一坐标y(云游的是这个用途)
UINT_FIELD_VIEW_MODE = 157	-- 是否是观看模式
UINT_FIELD_VIRTUAL_CAMP = 158	-- 虚拟阵营
UINT_FIELD_XIANFU_INFO = 159	-- 跨服仙府的信息4bytes (0:宝箱数量, 1:死亡次数)
UINT_FIELD_VIP_LEVEL = 160	-- VIP等级
UINT_FIELD_VIP_TIME_OUT = 161	-- VIP超时时间
UINT_FIELD_VAMPIRIC = 162	-- 当前战斗的吸血值
UINT_INT_FIELD_ILLUSION = 164	-- 角色幻化
UINT_FIELD_BOOS_CUR_SPELLID = 165	-- 当前正在释放的蓄力技能idUNIT_INT_FIELD_APPEARANCE
UINT_FIELD_BOOS_CUR_SPELL_TIME = 166	-- 前一个技能结束的时间戳
UINT_FIELD_BOOS_CUR_SPELL_LAST_COUNT = 167	--  持续技能数量
UINT_INT_FIELD_PASSIVE_SPELL_START = 168	-- 被动技能开始
UINT_INT_FIELD_PASSIVE_SPELL_END = 268	-- 被动技能结束
UINT_INT_FIELD_WINGS_RANK = 268	-- 神羽阶数
UNIT_INT_FIELD_APPEARANCE = 269	--  外观
UNIT_INT_FIELD_RISK_CREATURE_ID = 270	--  世界冒险怪物对应的序号
UNIT_INT_FIELD_OPERATE_CD = 271	-- 场景服操作冷却
MAX_UNIT_FIELD = 272
...
PLAYER_FIELD_ATTR_RESERVE0 = 81	-- 预留属性0
PLAYER_FIELD_ATTR_RESERVE1 = 83	-- 预留属性1
PLAYER_FIELD_ATTR_RESERVE2 = 85	-- 预留属性2
PLAYER_FIELD_ATTR_RESERVE3 = 87	-- 预留属性3
PLAYER_FIELD_ATTR_RESERVE4 = 89	-- 预留属性4
PLAYER_FIELD_ATTR_RESERVE5 = 91	-- 预留属性5
PLAYER_FIELD_ATTR_RESERVE6 = 93	-- 预留属性6
PLAYER_FIELD_ATTR_RESERVE7 = 95	-- 预留属性7
PLAYER_FIELD_BUFF = 97	-- BUFF
PLAYER_FIELD_BUFF_RESERVE = 147	-- BUFF保留参数	
PLAYER_INT_FIELD_BUFF_GIVER_UINT_GUID = 197	-- buff giver的uintGuid
PLAYER_INT_FIELD_BUFF_EFFECT_ID_START = 247	-- buff等级 (byte)
PLAYER_INT_FIELD_BUFF_EFFECT_ID_END = 297
PLAYER_FIELD_SKIN = 297	-- 生物变身
PLAYER_FIELD_BYTES_1 = 298	-- 四个字节,分别存放 0怪物分类
PLAYER_FIELD_FORCE = 299	-- 战斗力
PLAYER_FIELD_EQUIPMENT = 301	-- 装备列表，12个32位预留三个
PLAYER_FIELD_CUR_MOUNT = 321	-- 当前坐骑模板id
PLAYER_FIELD_PEACE_MODE_CD = 322	-- 和平模式CD
PLAYER_FIELD_NOTORIETY = 323	-- 2个short(0:战斗模式, 1:恶名值)
PLAYER_FIELD_BYTES_2 = 324	-- 玩家标识,存4个byte[0灰名时间 1付费等级 2免费复活 3玩家称号]
PLAYER_FIELD_BYTES_3 = 325	-- 四个字节,分别存放 0头像,[1发型2可用技能槽数量3下次复活是否有保护buff]
PLAYER_FIELD_BYTES_4 = 326	-- 四个字节,分别存放 (0:频道屏蔽列表,1:预留,2:预留,3:预留)
PLAYER_FIELD_BYTES_5 = 327	-- 0 GM权限, 1, 2 
PLAYER_FIELD_AUTO_HP = 328	-- 大红
PLAYER_FIELD_AUTO_MP = 330	-- 大蓝
PLAYER_FIELD_VIP_LEVEL = 332	-- VIP 等级
PLAYER_FIELD_VIP_TIME_OUT = 333	-- VIP 超时时间
--  挂机设置
PLAYER_FIELD_HOOK = 334	-- 挂机状态
PLAYER_FIELD_HOOK_BYTE0 = 335	-- 0:槽1技能,1:槽2技能,2:槽3技能,3:槽4技能
PLAYER_FIELD_HOOK_BYTE1 = 336	-- 0:神兵技能,1:怒气技能2:使用银两买药,3:银两不足用元宝买药
PLAYER_FIELD_HOOK_SHORT = 337	-- 0:自动吃药百分比,1:自动使用道具id
PLAYER_FIELD_HOOK_BYTE3 = 338	-- 0:回程复活/原地复活,1:自动使用绑银购买复活丹,2:绑银不足用元宝,3:自动出售某种平直及以下装备
PLAYER_FIELD_FLAGS = 339	-- 主玩家下标flags
PLAYER_FIELD_FLAGS_END = 347	-- 预留8个32位flags
PLAYER_FIELD_ONLINE_TIME = 347	-- 总在线时长(分钟为单位)
PLAYER_FIELD_ANGER = 348	-- 怒气改变
PLAYER_FIELD_TRIAL_LAYERS = 349
PLAYER_INT_FIELD_TRIAL_FINISHED_SECTIONID = 350	-- (已经通关的关卡id)
PLAYER_INT_FIELD_TRIAL_PROCESS = 351	-- (0:已经杀的怪,1:总共需要杀的怪)
PLAYER_FIELD_DECLINE_CHANNEL_BYTE0 = 352	-- 拒绝频道A(0系统，1帮派，2组队，3世界)
PLAYER_FIELD_DECLINE_CHANNEL_BYTE1 = 353	-- 拒绝频道B(0:附近)
PLAYER_SCENED_INT_FIELD_PLAYER_JUMP_CD = 354	-- 跳跃CD
PLAYER_INT_FIELD_SYSTEM_MAIL_ID = 355	-- 当前领取的系统邮件的id
PLAYER_FIELD_DIVINE_NUM = 356	-- 神兵数量
PLAYER_FIELD_DIVINE_FORCE = 357	-- 神兵总战斗力
PLAYER_FIELD_MOUNT_FORCE = 358	-- 坐骑总战力
PLAYER_FIELD_SKILL_FORCE = 359	-- 技能战力
PLAYER_FILED_GEM_FORCE = 360	-- 宝石战力
PLAYER_FIELD_STRENGTH_FORCE = 361	-- 强化战力
PLAYER_FIELD_RANK_LIKE = 362
PLAYER_FIELD_USE_RANK_LIKE = 363
PLAYER_FIELD_SHOP_LIMIT_START = 364
PLAYER_FIELD_SHOP_LIMIT_END = 384
PLAYER_EXPAND_INT_FCM_LOGIN_TIME = 384	-- 防沉迷，单位：分钟	-1是非防沉迷玩家
PLAYER_EXPAND_INT_FCM_LOGOUT_TIME = 385	-- 防沉迷离线时间
PLAYER_EXPAND_INT_CREATE_TIME = 386	-- 角色创建时间
PLAYER_EXPAND_INT_LAST_LOGIN_TIME = 387	-- 最后登录时间
PLAYER_EXPAND_INT_LAST_LOGOUT_TIME = 388	-- 最后离线时间
PLAYER_EXPAND_INT_NUMBER_OF_LOGINS = 389	-- 累积登录次数
PLAYER_EXPAND_INT_MONEY = 390	-- 各种货币
PLAYER_EXPAND_INT_MONEY_END = 434
PLAYER_EXPAND_INT_USE_FASHION = 434	-- 是否启用时装,目前用到20个pos
PLAYER_EXPAND_INT_XP = 435	-- 当前经验，64位
PLAYER_EXPAND_INT_NEXT_LEVEL_XP = 437	-- 下一级经验，64位
PLAYER_EXPAND_INT_XP_ADDED = 439	--  应用服增加的经验
PLAYER_EXPAND_INT_XP_PICKED = 441	--  场景服已经领取的应用服增加的经验
PLAYER_EXPAND_INT_MAP_STATUS = 443	--  地图开启进度
PLAYER_EXPAND_INT_GAG_END_TIME = 444	-- 禁言结束时间
PLAYER_EXPAND_INT_TO_MAP = 445	-- 玩家要传送到的地图
PLAYER_EXPAND_INT_TO_INSTANCE_ID = 446	-- 玩家要传送到的地图实例ID
PLAYER_EXPAND_INT_TO_POS_X = 447	-- 玩家药传送到的坐标
PLAYER_EXPAND_INT_TO_POS_Y = 448
PLAYER_EXPAND_INT_TO_LINE_NO = 449	-- 传送线号
PLAYER_EXPAND_INT_DB_MAP = 450	-- 玩家最后一次进入副本前的地图	
PLAYER_EXPAND_INT_DB_POS_X = 451	-- 玩家最后一次进入副本前的坐标
PLAYER_EXPAND_INT_DB_POS_Y = 452
PLAYER_EXPAND_INT_CLIENT_DATA = 453	-- 远程存储
-- ////////////////////////////////////////////////////////////////////////
-- 应用服部分	
PLAYER_APPD_INT_FIELD_FLAG = 553	-- 玩家标志位
PLAYER_APPD_INT_FIELD_FLAG_END = 560	-- 结束下标
PLAYER_APPD_INT_FIELD_DAILY_TIME = 560	--  每天在线时长（min）
PLAYER_APPD_INT_FIELD_RESET_WEEK = 561	--  每周重置时间
PLAYER_APPD_INT_FIELD_RESET_DALIY = 562	-- 重置的时间点每小时一次
PLAYER_APPD_INT_FIELD_RECHARGE_SUM = 586	-- 累计充值总数
PLAYER_APPD_INT_FIELD_LAST_RECHARGE_TIME = 587	-- 最后一笔充值时间
PLAYER_APPD_INT_FLELD_JHM_FLAGS = 588	-- 激活码flags
PLAYER_APPD_INT_FLELD_JHM_FLAGS_END = 596	-- 激活码flags_end
-- 主背包扩展时间戳
PLAYER_APPD_INT_FIELD_EXTENSION_END_TIME = 597	-- 主包裹扩展结束时间戳
PLAYER_APPD_INT_FIELD_EXTENSION_REMAIN_TIME = 598	-- 主包裹扩展剩余多少时间
PLAYER_INT_FIELD_BLOCK_COUNT = 600	-- 屏蔽列表个数
PLAYER_INT_FIELD_WORLD_BOSS_JOIN_ID = 601	-- 最后一次参加的世界BOSS id
PLAYER_INT_FIELD_WORLD_BOSS_JOIN_STATE = 602	-- 0:最后一次参加的世界BOSS状态, 1:进入的线数,2:死亡次数,3:预留
-- 场景服扩展下标开始了
PLAYER_SCENED_INT_FLAGS = 603	-- 玩家场景服标志位
--  只显示装备的主动技能
PLAYER_INT_FIELD_SPELL_START = 611
PLAYER_INT_FIELD_SPELL_END = 623
-- 重要技能的CD
PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_START = 623
PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_END = 663
PLAYER_EXPAND_KILL_MONSTER = 663	-- 杀怪数
-- 跨服
PLAYER_APPD_INT_FIELD_KUAFU_WARID = 664	-- 跨服场次id
PLAYER_INT_FIELD_KUAFU_NUMBER = 665	-- 0:玩家报名跨服时收到匹配信息中给的编号 1:跨服类型（值参照枚举：EKUAFU_TYPE）
PLAYER_INT_FIELD_MAIN_QUEST_ID = 666	-- 当前主线任务
PLAYER_INT_FIELD_QUEST_CHAPTER = 667	-- 任务章节奖励领取情况
PLAYER_INT_FIELD_MOUNT_LEVEL = 668	-- 4个bytes(0:当前坐骑阶数 1:当前坐骑星级,2:当前坐骑是否骑乘，3:当前幻化id)
PLAYER_INT_FIELD_DIVINE_ID = 669	-- 当前装备的神兵id
PLAYER_INT_FIELD_PASSIVE_SPELL_START = 670	-- 被动技能开始
PLAYER_INT_FIELD_PASSIVE_SPELL_END = 770	-- 被动技能个数
PLAYER_INT_FIELD_VIRTUAL_CAMP = 770	-- 虚拟阵营
PLAYER_INT_FIELD_WORLD_3V3_SCORE = 771	-- 跨服3v3积分
PLAYER_INT_FIELD_WORLD_3V3_TOTAL_SCORE = 772	-- 跨服3v3积分
PLAYER_INT_FIELD_WORLD_3V3_TREND_INFO = 773	-- 胜负走势
PLAYER_INT_FIELD_DOUJIANTAI_RANK = 774	-- 斗剑台排名
PLAYER_INT_FIELD_DOUJIANTAI_REFRESH_TIME = 775	-- 最后一次刷新对手时间戳
PLAYER_INT_FIELD_ARREARS = 776	-- 欠费
PLAYER_INT_FIELD_DAILY_QUEST_FINISHED = 778	--  每日任务完成数
PLAYER_INT_FIELD_BAG_SORT_TIME = 779	-- 整理背包时间戳
-- 已开启功能的记录
PLAYER_INT_FIELD_OPEN_MENU_INDEX = 780
PLAYER_INT_FIELD_OPEN_MENU_START = 781
PLAYER_INT_FIELD_OPEN_MENU_END = 881
-- 已购家族商店物品的记录
PLAYER_INT_FIELD_BUYED_FACTION_SHOP = 882	-- 已购家族商店物品开始
PLAYER_INT_FIELD_BUYED_FACTION_SHOP_END = 890	-- 已购家族商店物品结束
-- 记录强制引导ID 
PLAYER_INT_FIELD_GUIDE_ID_LAST = 891	-- 上次完成的引导
PLAYER_INT_FIELD_GUIDE_ID_NOW = 892	-- 当前进行中的引导
-- 修炼场相关
PLAYER_INT_FIELD_CULTIVATION_LAST_PLUNDER_TIME = 893	-- 上次挑战时间戳
PLAYER_INT_FIELD_CULTIVATION_LAST_REFRESH_TIME = 894	-- 上次刷新对手时间戳
PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_EXP = 895	-- 当日累计掠夺经验
PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_CHEST = 896	-- 当日累计掠夺宝箱数
PLAYER_INT_FIELD_CULTIVATION_TODAY_PURCHASE_COUNT = 897	-- 当日购买次数
PLAYER_INT_FIELD_CULTIVATION_LEFT_PLUNDER_COUNT = 898	-- 当前剩余挑战次数
PLAYER_INT_FIELD_CULTIVATION_PLUNDER_RECORD_INDEX = 899	-- 修练场修炼记录下标
PLAYER_INT_FIELD_CULTIVATION_TOTAL_BEEN_PLUNDER_COUNT = 900	-- 本轮被掠夺成功次数
PLAYER_INT_FIELD_CULTIVATION_TODAY_TOTAL_PLUNDER_COUNT = 901	-- 本日总掠夺次数
PLAYER_INT_FIELD_CULTIVATION_START_TIME = 902	-- 修炼开始时间
PLAYER_INT_FIELD_CULTIVATION_LOST_INFO = 903	-- 修炼宝箱丢失信息
-- 登陆大礼相关
PLAYER_INT_FIELD_LOGIN_ACTIVITY_TOTAL_DAYS = 904	-- 登陆总天数
PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_START = 905	-- 领取状态开始
PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_END = 907	-- 领取状态结束
--  非强制引导ID
PLAYER_INT_FIELD_OPTIONAL_GUIDE_START = 908	-- 非强制引导开始
PLAYER_INT_FIELD_OPTIONAL_GUIDE_END = 968	--  非强制引导结束
PLAYER_INT_FILED_LEAVE_RISK_TIME = 968	-- 离开冒险世界的时间戳
PLAYER_INT_FILED_LEAVE_RISK_SUIT_SCORE = 969	-- 是否已经领取不在冒险世界的挂机奖励
PLAYER_INT_FILED_FACTION_BUILDING_SPEEDUP_DAILY_COUNT = 970	-- 家族建筑升级加速每日次数
PLAYER_INT_FILED_FACTION_DONATE_GIFT_EXCHANGE_DAILY_COUNT = 971	-- 家族宝库贡献礼物兑换每日次数
PLAYER_INT_FILED_CHARM_POINT = 972	-- 魅力值
PLAYER_INT_FILED_FACTION_GIFT_NEXT_COUNT_ID = 974	-- 玩家礼物历史记录下一个count_id
PLAYER_INT_FILED_FACTION_GIFT_START = 975	-- 玩家礼物历史记录开始
PLAYER_INT_FILED_FACTION_GIFT_END = 1725
PLAYER_INT_FIELD_CREATE_ICON = 1725	-- 待创建的帮派icon
PLAYER_INT_FIELD_FACTION_GIFT_POINT_COUNT = 1726	-- 帮派魅力赠送总记数
PLAYER_INT_FIELD_FACTION_GIFT_SEND_COUNT = 1728	-- 帮派礼物赠送总记数
PLAYER_INT_FIELD_FACTION_GIFT_BEEN_THANK_COUNT = 1729	-- 帮派礼物赠送被女王感谢记数
PLAYER_INT_FIELD_MASS_BOSS_BUYED_TIMES = 1730	-- 已经购买次数
PLAYER_INT_FIELD_MASS_BOSS_TIMES = 1731	-- 全民boss次数
PLAYER_INT_FIELD_MASS_BOSS_CD = 1732	-- 全民boss回复cd(0:表示已满了, 只有次数不满的情况才有cd)
PLAYER_INT_FIELD_TALISMAN_FORCE = 1733	-- 法宝总战力
PLAYER_INT_FIELD_WINGS_FORCE = 1734	-- 神羽总战力
PLAYER_INT_FIELD_GROUP_INSTANCE_CLEAR_FLAG = 1735	-- 组队副本首次通关flag
PLAYER_INT_FIELD_MERIDIAN_FORCE = 1736	-- 经脉修炼战力
PLAYER_INT_FIELD_WINGS_RANK = 1737	-- 神羽阶数
PLAYER_INT_FIELD_FACTION_BOSSDEFENSE_TICKETS = 1738	-- 家族首领挑战剩余次数
PLAYER_INT_FIELD_FACTION_TOWER_CLEAR_FLOOR = 1739	-- 家族无尽远征 历史挑战层数
PLAYER_INT_FIELD_FACTION_TOWER_FLAG = 1740	-- 0 扫荡状态 1~15 宝箱领取状态
PLAYER_INT_FIELD_QUALIFY_SCORE = 1741	--  排位赛积分
PLAYER_INT_FIELD_FACTION_SKILL_LV_START = 1742	-- 家族技能等级开始 0:已学习等级 uint16 1:当前生效等级
PLAYER_INT_FIELD_FACTION_SKILL_LV_END = 1762	-- 家族技能等级结束
PLAYER_INT_FIELD_APPEARANCE = 1762	--  外观(0:武器,1:衣服)
PLAYER_INT_FIELD_WEAPON_FORCE = 1763	--  武器外观战力
PLAYER_INT_FIELD_CLOTH_FORCE = 1764	--  衣服外观战力
PLAYER_INT_FIELD_POKEDEX_FORCE = 1765	--  图鉴战力
PLAYER_INT_FIELD_TITLE_FORCE = 1766	--  称号战力
PLAYER_INT_FIELD_RENAME_TIMES = 1767	--  改名次数
PLAYER_INT_FIELD_REVENGE_TIMES = 1768	-- 当日剩余复仇次数
PLAYER_INT_FIELD_REVENGE_BUY_TIMES = 1769	-- 当日复仇购买次数
PLAYER_INT_FIELD_WINGS_STAR = 1770	-- 神羽星数
PLAYER_INT_FIELD_VIPGIFT_FLAG = 1771	-- vip礼包购买状态
PLAYER_APPD_INT_FIELD_CONSUME_SUM = 1772	-- 累计消费元宝
PLAYER_APPD_INT_FIELD_MONEYTREE_COUNT = 1773	-- 摇钱树摇钱次数
PLAYER_APPD_INT_FIELD_MONEYTREE_GIFT_FLAG = 1774	-- 摇钱树礼包领取状态
PLAYER_INT_FIELD_WORLD_RISK_LAST_ID = 1775	-- 最后一次进入的幻境地图id
PLAYER_INT_FIELD_LAST_INSTANCE_TYPE = 1776	-- 上次副本子类型
PLAYER_INT_FIELD_LAST_INSTANCE_PARAM = 1777	-- 上次副本额外参数
PLAYER_EXPAND_INT_LAST_IS_RISK = 1778	-- 最后一次进的是幻境
PLAYER_INT_FIELD_RESTORE_POTION_CD = 1779	-- 回复药功能CD
PLAYER_INT_FIELD_ESCORT_ROB_COUNT = 1780	-- 劫镖次数
PLAYER_INT_FIELD_ADVENTURE_ROBOT_KILL_COUNT = 1781	-- 冒险击杀机器人计数
PLAYER_INT_FIELD_REALMBREAK_LEVEL = 1782	-- 境界突破等级
PLAYER_INT_FIELD_REALMBREAK_EXP = 1783	-- 境界突破当前经验
PLAYER_INT_FIELD_REALMBREAK_DAILYQUEST_STATE = 1784	-- 境界突破每日任务 0,uint16完成次数 1,uint16领取状态
PLAYER_INT_FIELD_OPERATE_CD = 1785	-- 所有操作公用CD
PLAYER_INT_FIELD_PASSED_STAGE_INSTANCE_ID = 1786	-- 已通关闯关副本Id
-- ////////////////////////////////////////////////////////////////////////////////////////////////////////
-- 字符串部分
...
MAX_FACTION_BUFF = 2
MAX_GROUP_MEMBER_COUNT = 5
GROUP_MEMBER_INT_LEVEL = 0	-- 队员信息
MAX_GROUP_MEMBER_INFO_INT_COUNT = 1
GROUP_MEMBER_STR_GUID = 0	--  玩家guid
MAX_GROUP_MEMBER_INFO_STR_COUNT = 1
GROUP_INT_FIELD_MEMBER_INFO_START = 0
GROUP_INT_FIELD_MEMBER_INFO_END = 5
GROUP_STR_FIELD_MEMBER_INFO_START = 0
GROUP_STR_FIELD_MEMBER_INFO_END = 5
...
FACTION_INT_FIELD_PLAYER_END = 552	-- 帮派申请索引
FACTION_INT_FIELD_APPLY_PLAYER_COUNT_INDEX = 552
FACTION_INT_FIELD_APPLY_PLAYER = 553	-- 玩家申请加入帮派列表
FACTION_INT_FIELD_APPLY_PLAYER_END = 586	-- 帮派申请玩家列表
FACTION_INT_FIELD_EVENT = 586	-- 帮派记录开始
FACTION_INT_FIELD_EVENT_END = 606	-- 帮派记录结束
FACTION_INT_FIELD_EVENT_FALG = 606	-- 帮派记录标志位
FACTION_INT_FIELD_SHOP = 607	-- 商店开始
FACTION_INT_FIELD_SHOP_END = 615	-- 商店结束
FACTION_INT_FIELD_FORCE = 615	-- 帮派战斗力
FACTION_INT_FIELD_MONEY = 617	-- 帮派资产
FACTION_INT_FIELD_LEVEL = 619	-- 帮派等级
FACTION_INT_FIELD_ACTIVITY = 620	-- 帮派活跃度
FACTION_INT_FIELD_RANK = 621	-- 帮派排名
FACTION_INT_FIELD_FLAGS_ID = 622	-- (byte)0:帮派当前选择的旗帜ID (byte)1:神明等级 (uint16)1:灵气
FACTION_INT_FIELD_MINLEV = 623	-- 加入帮派最小等级
FACTION_INT_FIELD_TOKEN_NUM = 624	-- 令牌数量
FACTION_INT_FIELD_TOKEN_POINTS = 625	-- 令牌今日积分进度
FACTION_INT_FIELD_TOKEN_POINTS_COUNT = 626	-- 令牌今日积分完成次数
FACTION_INT_FIELD_TOKEN_TODAY_BUY_COUNT = 627	-- 今日令牌购买次数
FACTION_INT_FIELD_CHALLENGE_BOSS_ID_MAX = 628	-- 已挑战最大boss id
FACTION_INT_FIELD_CHALLENGE_BOSS_ID = 629	-- 当前挑战boss id
FACTION_INT_FIELD_CHALLENGE_BOSS_START_TIME = 630	-- 当前挑战开始时间
FACTION_INT_FIELD_CHALLENGE_BOSS_HP_RATE = 631	-- 当前boss血量万分比
FACTION_INT_FIELD_CHALLENGE_BOSS_POS = 632	-- 当前boss位置 x,y
FACTION_INT_FIELD_PROTECT_TARGET_HP_RATE = 633	-- 当前守护目标血量万分比
FACTION_INT_FIELD_PROTECT_TARGET_POS = 634	-- 当前守护目标位置 x,y
FACTION_INT_FIELD_CHALLENGE_BOSS_DAMAGE_RANK_START = 635	-- 当前boss输出榜开始 int 输出值
FACTION_INT_FIELD_CHALLENGE_BOSS_DAMAGE_RANK_END = 685	-- 当前boss输出榜结束
FACTION_INT_FIELD_CHALLENGE_BOSS_TOTAL_RANK_START = 685	-- 总输出榜开始
FACTION_INT_FIELD_CHALLENGE_BOSS_TOTAL_RANK_END = 735	-- 总输出榜结束
FACTION_INT_FIELD_STOREHOUSE_ITEM_COUNT = 735	-- 宝库道具数量
FACTION_INT_FIELD_STOREHOUSE_RECORD_CURSOR = 736	-- 宝库记录游标
FACTION_INT_FIELD_BUILDING_ID_START = 737	-- 已有建筑id开始
FACTION_INT_FIELD_BUILDING_ID_END = 747	-- 已有建筑id结束
FACTION_INT_FIELD_BUILDING_LVUP_ID = 747	-- 当前正在升级的建筑id
FACTION_INT_FIELD_BUILDING_LVUP_FINISH_TIME = 748	-- 当前升级建筑完成时间戳
FACTION_INT_FIELD_IS_DISSOLVED = 749	-- 是否解散
FACTION_INT_FIELD_GIFT_WEEK_POINT_START = 750	-- 礼物周榜魅力值计数开始
FACTION_INT_FIELD_GIFT_WEEK_POINT_END = 800	-- 礼物周榜魅力值计数结束
FACTION_INT_FIELD_GIFT_UNCHECK_COUNT_START = 800	-- 未处理礼物计数开始 女王未感谢 成员为领取
FACTION_INT_FIELD_GIFT_UNCHECK_COUNT_END = 850	-- 未处理礼物计数结束
FACTION_INT_FIELD_CHARM_POINT = 851	-- 帮派女王魅力值 double
FACTION_INT_FIELD_GIFT_SEND_COUNT_START = 853	-- 今日赠送礼物次数开始
FACTION_INT_FIELD_GIFT_SEND_COUNT_END = 903	-- 今日赠送礼物次数结束
FACTION_INT_FIELD_GIFT_LAST_SEND_TIME = 903	-- 最后赠送的时间
FACTION_INT_FIELD_GIFT_QUEEN_UNCHECK_COUNT = 905	-- 女王未处理礼包数
FACTION_INT_FIELD_BOSSDENFENSE_START = 906	-- 家族首领挑战信息开始
FACTION_INT_FIELD_BOSSDENFENSE_END = 930	-- 家族首领挑战信息结束
FACTION_INT_FIELD_TOWER_TODAY_TOP_FLOOR = 930	-- 无尽远征 每日最高者 层数 int32
FACTION_INT_FIELD_TOWER_TODAY_TOP_ICON = 931	-- 无尽远征 每日最高者 头像 int32
FACTION_INT_FIELD_TOWER_TODAY_TOP_FORCE = 932	-- 无尽远征 每日最高者 战力 double
FACTION_INT_FIELD_TOTAL_FORCE = 934	--  double 帮派成员总战力
FACTION_INT_FIELD_MANGER_COAT = 936	-- 帮主衣服
FACTION_INT_FIELD_MANGER_WEAPON = 937	-- 帮主武器
FACTION_INT_FIELD_MANGER_VIP = 938	-- 帮主vip
FACTION_INT_FIELD_MANGER_GENDER = 939	-- 帮主gender
FACTION_INT_FIELD_MANGER_TITLE = 940	-- 帮主title
FACTION_INT_FIELD_MANGER_LIKE = 941	-- 帮主点赞
FACTION_INT_FIELD_MANGER_WING = 942	-- 帮主神羽
...
INSTANCE_INT_FIELD_ACTIVE_START = 10	-- 活动开始
INSTANCE_INT_FIELD_ACTIVE_END = 60	-- 活动结束
INSTANCE_INT_FIELD_ACTIVE = 60	-- 活动-活跃度
INSTANCE_INT_FIELD_ACTIVE_REWARD = 61	-- 奖励领取状态
INSTANCE_INT_FIELD_3V3_TIMES = 62	-- 3v3次数 已参加次数 购买次数
INSTANCE_INT_FIELD_3V3_DAY_REWARD = 63	-- 3v3每日次数奖励 4个byte
INSTANCE_INT_FIELD_3V3_SEGMENT_TIME = 64	-- 3v3段位 发放时间
INSTANCE_INT_FIELD_XIANFU_DAY_TIMES = 65	-- 每日挑战次数
INSTANCE_INT_FIELD_DOUJIANTAI_CURSOR = 66	-- 斗剑台信息游标
INSTANCE_INT_FIELD_DOUJIANTAI_ENEMY_S = 67	-- 对手名次开始
INSTANCE_INT_FIELD_DOUJIANTAI_ENEMY_E = 70	-- 对手名次结束
INSTANCE_INT_FIELD_DOUJIAN_TIMES = 71	-- 斗剑次数 已挑战次数 购买次数
INSTANCE_INT_FIELD_DOUJIAN_FIGHT_CD = 72	-- 斗剑台挑战CD时间戳
INSTANCE_INT_FIELD_DOUJIAN_FIRST_GET = 73	-- 首胜奖励标记
INSTANCE_INT_FIELD_DOUJIAN_FIRST_REWARD = 74	-- 首胜奖励领取标记
INSTANCE_INT_FIELD_DOUJIAN_COMBATWIN = 75	-- 连胜纪录 纪录 当前
INSTANCE_INT_FIELD_DOUJIAN_COMBATWIN_REWARD = 76	-- 连胜奖励记录
INSTANCE_INT_FIELD_DOUJIAN_MAX_RANK = 77	-- 历史最高纪录
INSTANCE_INT_FIELD_GROUP_INSTANCE_CLEAR_FLAG = 78	-- 每bit记录对应组队副本id首次通关状态 false:未完成 true:已完成
INSTANCE_INT_FIELD_GROUP_INSTANCE_CHALLENGE_COUNT = 79	-- 组队副本剩余挑战次数
INSTANCE_INT_FIELD_GROUP_INSTANCE_BUY_COUNT = 80	-- 当日组队副本挑战次数购买次数
INSTANCE_INT_FIELD_QUALIFY_EXTRA = 81	--  排位赛胜利额外可领取奖励标志
INSTANCE_INT_FIELD_QUALIFY_WINS = 82	--  排位赛赢得场次		
INSTANCE_INT_FIELD_QUALIFY_EXTRA_PICKED = 83	--  排位赛胜利额外已领取奖励标志
INSTANCE_INT_FIELD_QUALIFY_DAILY_TIMES = 84	--  排位赛每天次数
INSTANCE_INT_FIELD_QUALIFY_BUY_TIMES = 85	--  排位赛购买次数
INSTANCE_INT_FIELD_QUALIFY_CURSOR = 86	--  排位赛记录游标
INSTANCE_INT_FIELD_PRIVATE_BOSS_RECOVER_TIME_START = 87	-- 个人BOSS挑战次数回复时间戳开始
INSTANCE_INT_FIELD_PRIVATE_BOSS_RECOVER_TIME_END = 107	-- 个人BOSS挑战次数回复时间戳结束
INSTANCE_INT_FIELD_STAGE_INSTANCE_BONUS_FLAG_START = 108	-- 闯关宝箱领取状态开始
INSTANCE_INT_FIELD_STAGE_INSTANCE_BONUS_FLAG_END = 118	-- 闯关宝箱领取状态结束
...
MAP_INT_FIELD_INSTANCE_TYPE = 42	-- 副本类型
-- 地图字符串部分
MAP_STR_GENERAL_ID = 4
MAP_STR_REWARD = 5	-- 副本奖励物品字符串
-- 小怪陆续刷
REFRESH_MONSTER_FIELD_ID = 46	-- 2个short(0:当前已经刷的,1:总共需要刷多少怪)
REFRESH_MONSTER_FIELD_INFO_START = 47	-- 怪物信息开始2个short(0:entry,1:level)
...
MAX_KUAFU_3V3_INT_COUNT = 5	--  kuafu属性数量
KUAFU_3V3_PLAYER_NAME = 0	-- 玩家名称
KUAFU_3V3_PLAYER_GUID = 1	-- 玩家guid
MAX_KUAFU_3V3_STR_COUNT = 2
MAX_KUAFU_3V3_COUNT = 6
--  跨服3v3匹配
KUAFU_3V3_FIELDS_INT_INFO_START = 43	--  跨服数据开始
KUAFU_3V3_FIELDS_INT_INFO_END = 73	--  3v3总共6个人
...
--  跨服仙府夺宝匹配
KUAFU_XIANFU_FIELDS_INT_INFO_START = 43	--  跨服数据开始
KUAFU_XIANFU_FIELDS_INT_INFO_END = 113	--  3v3总共6个人
KUAFU_XIANFU_FIELDS_INT_BOSS_INDX = 113	-- 当前的bossid
KUAFU_XIANFU_FIELDS_INT_BOSS_INFO_START = 114	-- BOSS信息开始
KUAFU_XIANFU_FIELDS_INT_BOSS_INFO_END = 129
KUAFU_XIANFU_FIELDS_HARD = 129	-- 副本难度
XIANFU_TEST_DUMMY_COUNT = 130	-- 假人数量
...
-- 跨服组队
KUAFU_GROUP_INSTANCE_FIELDS_HARD = 43	--  难度
KUAFU_GROUP_INSTANCE_FIELDS_PART = 44	--  组队副本的第几部分
KUAFU_GROUP_INSTANCE_INT_FIELDS_PLAYER_INFO_START = 45
KUAFU_GROUP_INSTANCE_INT_FIELDS_PLAYER_INFO_END = 51
KUAFU_GROUP_INSTANCE_STR_FIELDS_PLAYER_INFO_START = 45
KUAFU_GROUP_INSTANCE_STR_FIELDS_PLAYER_INFO_END = 54
DOUJIANTAI_FIELDS_INT_RANK = 43	--  2 shorts (0:自己的排名, 1:对手的排名)
DOUJIANTAI_FIELDS_INT_COMBAT_WIN_INFO = 44	--  2 shorts (0:历史最大连胜, 1:当前连胜)
XIULIANCHANG_FIELDS_INT_RANK = 43	--  敌人斗剑台排行
XIULIANCHANG_FIELDS_INT_ROBOT_ID = 44	--  敌人机器人序号
XIULIANCHANG_FIELDS_INT_LEVEL = 45	-- 敌人等级 结算经验用
...
-- VIP BOSS
VIP_INSTANCE_FIELD_ID = 43	--  0:VIP副本序号,1:副本难度
MAP_MASS_BOSS_INT_FIELD_ID = 43	-- 全民bossid
MAP_MASS_BOSS_INT_FIELD_MAX_HP = 44
MAP_PRIVATE_BOSS_INT_FIELD_ID = 43	-- 个人bossid
MAP_PRIVATE_BOSS_INT_FIELD_BUFFEFFECT_ID = 44	-- buff效果id
WORLDBOSS_FIELDS_WAIT_TIME = 43	-- 报名等待时间戳
WORLDBOSS_FIELDS_BORN_TIME = 44	-- 刷新等待时间戳
RES_INSTANCE_FIELD_ID = 43	-- 资源副本的索引
STAGE_INSTANCE_BUFF_ID = 44	-- 闯关副本场景buffid
-- 世界冒险
TRIAL_INSTANCE_FIELD_CURSOR = 43	-- 当前已经刷了多少波了
TRIAL_INSTANCE_FIELD_SECTION_ID = 44	-- 关卡id
TRIAL_INSTANCE_FIELD_ORDER = 45	-- 刷怪优先级序号(1个byte存一个数据)
TRIAL_INSTANCE_FIELD_BOSS_REFRESHED = 47	-- 是否已经刷怪
TRIAL_INSTANCE_FIELD_LAST_RANDOM_TIMESTAMP = 48	-- 最近随机刷怪时间戳
-- 家族场景
FACTION_INSTANCE_FIELD_GUID = 6	--  家族GUID string
-- 家族首领挑战场景
FACTION_BOSSDEFENSE_INSTANCE_FIELD_BUILDING_LV = 43	-- 家族建筑等级
FACTION_BOSSDEFENSE_INSTANCE_FIELD_INDEX = 44	-- boss点 index
FACTION_BOSSDEFENSE_INSTANCE_FIELD_POOL_ID = 45	-- 怪物池 id
FACTION_BOSSDEFENSE_INSTANCE_FIELD_HP = 46	-- 怪物剩余hp
...
-- 家族无尽远征场景
FACTION_TOWER_INSTANCE_FIELD_FLOOR = 43	--  当前层数
FACTION_TOWER_INSTANCE_FIELD_BUFF = 44	--  玩家获得的buffeffect_id
FACTION_TOWER_INSTANCE_FIELD_DEBUFF = 45	-- 玩家获得的debuffeffect_id
FACTION_TOWER_INSTANCE_FIELD_MONSTER_NUM = 46	-- 当前怪物数量
-- 试炼塔
TRIAL_INSTANCE_FIELD_ID = 43	--  当前层数
--  桃花迷阵最大刷新次数
TAOHUA_REFRESH_TIMES = 10
-- 桃花迷阵地图数据
TAOHUA_INT_FIELD_REFRESH_TIMES = 43	-- 桃花迷阵已经刷新次数
TAOHUA_INT_FIELD_BOSS_CURR_HP = 44	-- BOSS当前血量
TAOHUA_STR_FIELD_REAL_BOSS_GUID = 5	-- BOSS真身GUID
-- 塔的最大层数
TOWER_MAX_FLOOR = 2
-- 塔怪每层击杀数量
TAGUAI_INT_FIELD_FIRST_FLOOR = 43	-- 第一层的信息
-- 战斗信息整形字符型枚举
-- 貌似没必要,随便留一个吧
