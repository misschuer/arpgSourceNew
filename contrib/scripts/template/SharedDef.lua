...
UNIT_FIELD_ATTRIBUTE_END = 119	--  属性结束
UNIT_FIELD_MAX_HEALTH_BASE = 119	-- 最大生命
UNIT_FIELD_DAMAGE_BASE = 120	-- 攻击力
UNIT_FIELD_ARMOR_BASE = 121	-- 防御力
UNIT_FIELD_HIT_BASE = 122	-- 命中
UNIT_FIELD_MISS_BASE = 123	-- 闪避
UNIT_FIELD_CRIT_BASE = 124	-- 暴击
UNIT_FIELD_TOUGH_BASE = 125	-- 坚韧
UNIT_FIELD_ATTACK_SPEED_BASE = 126	-- 攻击速度
UNIT_FIELD_MOVE_SPEED_BASE = 127	-- 移动速度
UNIT_FIELD_IGNORE_ARMOR_BASE = 128	-- 忽视防御
UNIT_FIELD_IGNORE_MISS_BASE = 129	-- 忽视闪避
UNIT_FIELD_RECOVERY_BASE = 130	-- 生命值回复
UNIT_FIELD_DAMAGE_AMPLIFY_RATE_BASE = 131	-- 伤害加深(万分比)
UNIT_FIELD_DAMAGE_RESIST_RATE_BASE = 132	-- 伤害减免(万分比)
UNIT_FIELD_DAMAGE_RETURN_RATE_BASE = 133	-- 反弹伤害(万分比)
UNIT_FIELD_VAMPIRIC_RATE_BASE = 134	-- 吸血光环(万分比)
UNIT_FIELD_RECOVERY_RATE_BASE = 135	-- 回复效率(万分比)
UNIT_FIELD_CRIT_RATE_BASE = 136	-- 暴击率(万分比)
UNIT_FIELD_CRIT_RESIST_RATE_BASE = 137	-- 抗暴率(万分比)
UNIT_FIELD_CRIT_DAM_RATE_BASE = 138	-- 暴击伤害倍数(万分比)
UNIT_FIELD_CRIT_RESIST_DAM_RATE_BASE = 139	-- 降暴伤害倍数(万分比)
UNIT_FIELD_HIT_RATE_BASE = 140	-- 命中率(万分比)
UNIT_FIELD_MISS_RATE_BASE = 141	-- 闪避率(万分比)
UNIT_FIELD_STUN_RATE_BASE = 142	-- 眩晕
UNIT_FIELD_ROOTS_RATE_BASE = 143	-- 定身
UNIT_FIELD_SILENCE_RATE_BASE = 144	-- 沉默
UNIT_FIELD_CHAOS_RATE_BASE = 145	-- 混乱
UNIT_FIELD_CHARM_RATE_BASE = 146	-- 魅惑
UNIT_FIELD_CONTROL_ENHANCE_RATE_BASE = 147	-- 控制增强
UNIT_FIELD_CONTROL_RESIST_RATE_BASE = 148	-- 控制减免
UNIT_FIELD_STRENGTH_ARMOR_BASE = 149	-- 强化护甲
UNIT_FIELD_ATTRIBUTE_BASE_END = 150	--  属性结束
UNIT_FIELD_ANGER = 150	-- 愤怒值
UNIT_FIELD_USE_RESPAWN_MAPID = 151	-- 使用复活丹的地图id
UNIT_FIELD_PROCESS_TIME = 152	--  进度条读完的时间戳
UNIT_FIELD_PROCESS_SECONDS = 153	--  读条总共需要时间	
UINT_FIELD_BOSS_DATA = 154	-- boss数据byte 0:boss状态 1:boss前一状态 2:boss索引(云游的是这个用途)
UINT_FIELD_BOSS_DATA1 = 155	-- boss数据byte 0:当前坐标x 1:当前坐标y 2:下一坐标x 3:下一坐标y(云游的是这个用途)
UINT_FIELD_VIEW_MODE = 155	-- 是否是观看模式
UINT_FIELD_VIRTUAL_CAMP = 156	-- 虚拟阵营
UINT_FIELD_XIANFU_INFO = 157	-- 跨服仙府的信息4bytes (0:宝箱数量, 1:死亡次数)
UINT_FIELD_VIP_LEVEL = 158	-- VIP等级
UINT_FIELD_VIP_TIME_OUT = 159	-- VIP超时时间
UINT_FIELD_VAMPIRIC = 160	-- 当前战斗的吸血值
UINT_INT_FIELD_ILLUSION = 162	-- 角色幻化
UINT_FIELD_BOOS_CUR_SPELLID = 163	-- 当前正在释放的蓄力技能idUNIT_INT_FIELD_APPEARANCE
UINT_FIELD_BOOS_CUR_SPELL_TIME = 164	-- 前一个技能结束的时间戳
UINT_FIELD_BOOS_CUR_SPELL_LAST_COUNT = 165	--  持续技能数量
UINT_INT_FIELD_PASSIVE_SPELL_START = 166	-- 被动技能开始
UINT_INT_FIELD_PASSIVE_SPELL_END = 266	-- 被动技能结束
UINT_INT_FIELD_WINGS_RANK = 266	-- 神羽阶数
UNIT_INT_FIELD_APPEARANCE = 267	--  外观
UNIT_INT_FIELD_RISK_CREATURE_ID = 268	--  世界冒险怪物对应的序号
MAX_UNIT_FIELD = 269
...
PLAYER_FIELD_ATTR_RESERVE0 = 79	-- 预留属性0
PLAYER_FIELD_ATTR_RESERVE1 = 81	-- 预留属性1
PLAYER_FIELD_ATTR_RESERVE2 = 83	-- 预留属性2
PLAYER_FIELD_ATTR_RESERVE3 = 85	-- 预留属性3
PLAYER_FIELD_ATTR_RESERVE4 = 87	-- 预留属性4
PLAYER_FIELD_ATTR_RESERVE5 = 89	-- 预留属性5
PLAYER_FIELD_ATTR_RESERVE6 = 91	-- 预留属性6
PLAYER_FIELD_ATTR_RESERVE7 = 93	-- 预留属性7
PLAYER_FIELD_BUFF = 95	-- BUFF
PLAYER_FIELD_BUFF_RESERVE = 145	-- BUFF保留参数	
PLAYER_INT_FIELD_BUFF_GIVER_UINT_GUID = 195	-- buff giver的uintGuid
PLAYER_INT_FIELD_BUFF_EFFECT_ID_START = 245	-- buff等级 (byte)
PLAYER_INT_FIELD_BUFF_EFFECT_ID_END = 295
PLAYER_FIELD_SKIN = 295	-- 生物变身
PLAYER_FIELD_BYTES_1 = 296	-- 四个字节,分别存放 0怪物分类
PLAYER_FIELD_FORCE = 297	-- 战斗力
PLAYER_FIELD_EQUIPMENT = 299	-- 装备列表，12个32位预留三个
PLAYER_FIELD_CUR_MOUNT = 319	-- 当前坐骑模板id
PLAYER_FIELD_PEACE_MODE_CD = 320	-- 和平模式CD
PLAYER_FIELD_NOTORIETY = 321	-- 2个short(0:战斗模式, 1:恶名值)
PLAYER_FIELD_BYTES_2 = 322	-- 玩家标识,存4个byte[0灰名时间 1付费等级 2免费复活 3玩家称号]
PLAYER_FIELD_BYTES_3 = 323	-- 四个字节,分别存放 0头像,[1发型2可用技能槽数量3下次复活是否有保护buff]
PLAYER_FIELD_BYTES_4 = 324	-- 四个字节,分别存放 (0:频道屏蔽列表,1:预留,2:预留,3:预留)
PLAYER_FIELD_BYTES_5 = 325	-- 0 GM权限, 1, 2 
PLAYER_FIELD_AUTO_HP = 326	-- 大红
PLAYER_FIELD_AUTO_MP = 328	-- 大蓝
PLAYER_FIELD_VIP_LEVEL = 330	-- VIP 等级
PLAYER_FIELD_VIP_TIME_OUT = 331	-- VIP 超时时间
--  挂机设置
PLAYER_FIELD_HOOK = 332	-- 挂机状态
PLAYER_FIELD_HOOK_BYTE0 = 333	-- 0:槽1技能,1:槽2技能,2:槽3技能,3:槽4技能
PLAYER_FIELD_HOOK_BYTE1 = 334	-- 0:神兵技能,1:怒气技能2:使用银两买药,3:银两不足用元宝买药
PLAYER_FIELD_HOOK_SHORT = 335	-- 0:自动吃药百分比,1:自动使用道具id
PLAYER_FIELD_HOOK_BYTE3 = 336	-- 0:回程复活/原地复活,1:自动使用绑银购买复活丹,2:绑银不足用元宝,3:自动出售某种平直及以下装备
PLAYER_FIELD_FLAGS = 337	-- 主玩家下标flags
PLAYER_FIELD_FLAGS_END = 345	-- 预留8个32位flags
PLAYER_FIELD_ONLINE_TIME = 345	-- 总在线时长(分钟为单位)
PLAYER_FIELD_ANGER = 346	-- 怒气改变
PLAYER_FIELD_TRIAL_LAYERS = 347
PLAYER_INT_FIELD_TRIAL_FINISHED_SECTIONID = 348	-- (已经通关的关卡id)
PLAYER_INT_FIELD_TRIAL_PROCESS = 349	-- (0:已经杀的怪,1:总共需要杀的怪)
PLAYER_FIELD_DECLINE_CHANNEL_BYTE0 = 350	-- 拒绝频道A(0系统，1帮派，2组队，3世界)
PLAYER_FIELD_DECLINE_CHANNEL_BYTE1 = 351	-- 拒绝频道B(0:附近)
PLAYER_SCENED_INT_FIELD_PLAYER_JUMP_CD = 352	-- 跳跃CD
PLAYER_INT_FIELD_SYSTEM_MAIL_ID = 353	-- 当前领取的系统邮件的id
PLAYER_FIELD_DIVINE_NUM = 354	-- 神兵数量
PLAYER_FIELD_DIVINE_FORCE = 355	-- 神兵总战斗力
PLAYER_FIELD_MOUNT_FORCE = 356	-- 坐骑总战力
PLAYER_FIELD_SKILL_FORCE = 357	-- 技能战力
PLAYER_FILED_GEM_FORCE = 358	-- 宝石战力
PLAYER_FIELD_STRENGTH_FORCE = 359	-- 强化战力
PLAYER_FIELD_RANK_LIKE = 360
PLAYER_FIELD_USE_RANK_LIKE = 361
PLAYER_FIELD_SHOP_LIMIT_START = 362
PLAYER_FIELD_SHOP_LIMIT_END = 382
PLAYER_EXPAND_INT_FCM_LOGIN_TIME = 382	-- 防沉迷，单位：分钟	-1是非防沉迷玩家
PLAYER_EXPAND_INT_FCM_LOGOUT_TIME = 383	-- 防沉迷离线时间
PLAYER_EXPAND_INT_CREATE_TIME = 384	-- 角色创建时间
PLAYER_EXPAND_INT_LAST_LOGIN_TIME = 385	-- 最后登录时间
PLAYER_EXPAND_INT_LAST_LOGOUT_TIME = 386	-- 最后离线时间
PLAYER_EXPAND_INT_NUMBER_OF_LOGINS = 387	-- 累积登录次数
PLAYER_EXPAND_INT_MONEY = 388	-- 各种货币
PLAYER_EXPAND_INT_MONEY_END = 432
PLAYER_EXPAND_INT_USE_FASHION = 432	-- 是否启用时装,目前用到20个pos
PLAYER_EXPAND_INT_XP = 433	-- 当前经验，64位
PLAYER_EXPAND_INT_NEXT_LEVEL_XP = 435	-- 下一级经验，64位
PLAYER_EXPAND_INT_XP_ADDED = 437	--  应用服增加的经验
PLAYER_EXPAND_INT_XP_PICKED = 439	--  场景服已经领取的应用服增加的经验
PLAYER_EXPAND_INT_MAP_STATUS = 441	--  地图开启进度
PLAYER_EXPAND_INT_GAG_END_TIME = 442	-- 禁言结束时间
PLAYER_EXPAND_INT_TO_MAP = 443	-- 玩家要传送到的地图
PLAYER_EXPAND_INT_TO_INSTANCE_ID = 444	-- 玩家要传送到的地图实例ID
PLAYER_EXPAND_INT_TO_POS_X = 445	-- 玩家药传送到的坐标
PLAYER_EXPAND_INT_TO_POS_Y = 446
PLAYER_EXPAND_INT_TO_LINE_NO = 447	-- 传送线号
PLAYER_EXPAND_INT_DB_MAP = 448	-- 玩家最后一次进入副本前的地图	
PLAYER_EXPAND_INT_DB_POS_X = 449	-- 玩家最后一次进入副本前的坐标
PLAYER_EXPAND_INT_DB_POS_Y = 450
PLAYER_EXPAND_INT_CLIENT_DATA = 451	-- 远程存储
-- ////////////////////////////////////////////////////////////////////////
-- 应用服部分	
PLAYER_APPD_INT_FIELD_FLAG = 551	-- 玩家标志位
PLAYER_APPD_INT_FIELD_FLAG_END = 558	-- 结束下标
PLAYER_APPD_INT_FIELD_DAILY_TIME = 558	--  每天在线时长（min）
PLAYER_APPD_INT_FIELD_RESET_WEEK = 559	--  每周重置时间
PLAYER_APPD_INT_FIELD_RESET_DALIY = 560	-- 重置的时间点每小时一次
PLAYER_APPD_INT_FIELD_RECHARGE_SUM = 584	-- 累计充值总数
PLAYER_APPD_INT_FIELD_LAST_RECHARGE_TIME = 585	-- 最后一笔充值时间
PLAYER_APPD_INT_FLELD_JHM_FLAGS = 586	-- 激活码flags
PLAYER_APPD_INT_FLELD_JHM_FLAGS_END = 594	-- 激活码flags_end
-- 主背包扩展时间戳
PLAYER_APPD_INT_FIELD_EXTENSION_END_TIME = 595	-- 主包裹扩展结束时间戳
PLAYER_APPD_INT_FIELD_EXTENSION_REMAIN_TIME = 596	-- 主包裹扩展剩余多少时间
PLAYER_INT_FIELD_BLOCK_COUNT = 598	-- 屏蔽列表个数
PLAYER_INT_FIELD_WORLD_BOSS_JOIN_ID = 599	-- 最后一次参加的世界BOSS id
PLAYER_INT_FIELD_WORLD_BOSS_JOIN_STATE = 600	-- 0:最后一次参加的世界BOSS状态, 1:进入的线数,2:死亡次数,3:预留
-- 场景服扩展下标开始了
PLAYER_SCENED_INT_FLAGS = 601	-- 玩家场景服标志位
--  只显示装备的主动技能
PLAYER_INT_FIELD_SPELL_START = 609
PLAYER_INT_FIELD_SPELL_END = 621
-- 重要技能的CD
PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_START = 621
PLAYER_INT_FIELD_IMPORTANT_SPELL_CD_END = 661
PLAYER_EXPAND_KILL_MONSTER = 661	-- 杀怪数
-- 跨服
PLAYER_APPD_INT_FIELD_KUAFU_WARID = 662	-- 跨服场次id
PLAYER_INT_FIELD_KUAFU_NUMBER = 663	-- 0:玩家报名跨服时收到匹配信息中给的编号 1:跨服类型（值参照枚举：EKUAFU_TYPE）
PLAYER_INT_FIELD_MAIN_QUEST_ID = 664	-- 当前主线任务
PLAYER_INT_FIELD_QUEST_CHAPTER = 665	-- 任务章节奖励领取情况
PLAYER_INT_FIELD_MOUNT_LEVEL = 666	-- 4个bytes(0:当前坐骑阶数 1:当前坐骑星级,2:当前坐骑是否骑乘，3:当前幻化id)
PLAYER_INT_FIELD_DIVINE_ID = 667	-- 当前装备的神兵id
PLAYER_INT_FIELD_PASSIVE_SPELL_START = 668	-- 被动技能开始
PLAYER_INT_FIELD_PASSIVE_SPELL_END = 768	-- 被动技能个数
PLAYER_INT_FIELD_VIRTUAL_CAMP = 768	-- 虚拟阵营
PLAYER_INT_FIELD_WORLD_3V3_SCORE = 769	-- 跨服3v3积分
PLAYER_INT_FIELD_WORLD_3V3_TOTAL_SCORE = 770	-- 跨服3v3积分
PLAYER_INT_FIELD_WORLD_3V3_TREND_INFO = 771	-- 胜负走势
PLAYER_INT_FIELD_DOUJIANTAI_RANK = 772	-- 斗剑台排名
PLAYER_INT_FIELD_DOUJIANTAI_REFRESH_TIME = 773	-- 最后一次刷新对手时间戳
PLAYER_INT_FIELD_ARREARS = 774	-- 欠费
PLAYER_INT_FIELD_DAILY_QUEST_FINISHED = 776	--  每日任务完成数
PLAYER_INT_FIELD_BAG_SORT_TIME = 777	-- 整理背包时间戳
-- 已开启功能的记录
PLAYER_INT_FIELD_OPEN_MENU_INDEX = 778
PLAYER_INT_FIELD_OPEN_MENU_START = 779
PLAYER_INT_FIELD_OPEN_MENU_END = 879
-- 已购家族商店物品的记录
PLAYER_INT_FIELD_BUYED_FACTION_SHOP = 880	-- 已购家族商店物品开始
PLAYER_INT_FIELD_BUYED_FACTION_SHOP_END = 888	-- 已购家族商店物品结束
-- 记录强制引导ID 
PLAYER_INT_FIELD_GUIDE_ID_LAST = 889	-- 上次完成的引导
PLAYER_INT_FIELD_GUIDE_ID_NOW = 890	-- 当前进行中的引导
-- 修炼场相关
PLAYER_INT_FIELD_CULTIVATION_LAST_PLUNDER_TIME = 891	-- 上次挑战时间戳
PLAYER_INT_FIELD_CULTIVATION_LAST_REFRESH_TIME = 892	-- 上次刷新对手时间戳
PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_EXP = 893	-- 当日累计掠夺经验
PLAYER_INT_FIELD_CULTIVATION_TODAY_PLUNDER_CHEST = 894	-- 当日累计掠夺宝箱数
PLAYER_INT_FIELD_CULTIVATION_TODAY_PURCHASE_COUNT = 895	-- 当日购买次数
PLAYER_INT_FIELD_CULTIVATION_LEFT_PLUNDER_COUNT = 896	-- 当前剩余挑战次数
PLAYER_INT_FIELD_CULTIVATION_PLUNDER_RECORD_INDEX = 897	-- 修练场修炼记录下标
PLAYER_INT_FIELD_CULTIVATION_TOTAL_BEEN_PLUNDER_COUNT = 898	-- 本轮被掠夺成功次数
PLAYER_INT_FIELD_CULTIVATION_TODAY_TOTAL_PLUNDER_COUNT = 899	-- 本日总掠夺次数
PLAYER_INT_FIELD_CULTIVATION_START_TIME = 900	-- 修炼开始时间
PLAYER_INT_FIELD_CULTIVATION_LOST_INFO = 901	-- 修炼宝箱丢失信息
-- 登陆大礼相关
PLAYER_INT_FIELD_LOGIN_ACTIVITY_TOTAL_DAYS = 902	-- 登陆总天数
PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_START = 903	-- 领取状态开始
PLAYER_INT_FIELD_LOGIN_ACTIVITY_REWARD_STATUS_END = 905	-- 领取状态结束
--  非强制引导ID
PLAYER_INT_FIELD_OPTIONAL_GUIDE_START = 906	-- 非强制引导开始
PLAYER_INT_FIELD_OPTIONAL_GUIDE_END = 966	--  非强制引导结束
PLAYER_INT_FILED_LEAVE_RISK_TIME = 966	-- 离开冒险世界的时间戳
PLAYER_INT_FILED_LEAVE_RISK_SUIT_SCORE = 967	-- 是否已经领取不在冒险世界的挂机奖励
PLAYER_INT_FILED_FACTION_BUILDING_SPEEDUP_DAILY_COUNT = 968	-- 家族建筑升级加速每日次数
PLAYER_INT_FILED_FACTION_DONATE_GIFT_EXCHANGE_DAILY_COUNT = 969	-- 家族宝库贡献礼物兑换每日次数
PLAYER_INT_FILED_CHARM_POINT = 970	-- 魅力值
PLAYER_INT_FILED_FACTION_GIFT_NEXT_COUNT_ID = 972	-- 玩家礼物历史记录下一个count_id
PLAYER_INT_FILED_FACTION_GIFT_START = 973	-- 玩家礼物历史记录开始
PLAYER_INT_FILED_FACTION_GIFT_END = 1723
PLAYER_INT_FIELD_CREATE_ICON = 1723	-- 待创建的帮派icon
PLAYER_INT_FIELD_FACTION_GIFT_POINT_COUNT = 1724	-- 帮派魅力赠送总记数
PLAYER_INT_FIELD_FACTION_GIFT_SEND_COUNT = 1726	-- 帮派礼物赠送总记数
PLAYER_INT_FIELD_FACTION_GIFT_BEEN_THANK_COUNT = 1727	-- 帮派礼物赠送被女王感谢记数
PLAYER_INT_FIELD_MASS_BOSS_BUYED_TIMES = 1728	-- 已经购买次数
PLAYER_INT_FIELD_MASS_BOSS_TIMES = 1729	-- 全民boss次数
PLAYER_INT_FIELD_MASS_BOSS_CD = 1730	-- 全民boss回复cd(0:表示已满了, 只有次数不满的情况才有cd)
PLAYER_INT_FIELD_TALISMAN_FORCE = 1731	-- 法宝总战力
PLAYER_INT_FIELD_WINGS_FORCE = 1732	-- 神羽总战力
PLAYER_INT_FIELD_GROUP_INSTANCE_CLEAR_FLAG = 1733	-- 组队副本首次通关flag
PLAYER_INT_FIELD_MERIDIAN_FORCE = 1734	-- 经脉修炼战力
PLAYER_INT_FIELD_WINGS_RANK = 1735	-- 神羽阶数
PLAYER_INT_FIELD_FACTION_BOSSDEFENSE_TICKETS = 1736	-- 家族首领挑战剩余次数
PLAYER_INT_FIELD_FACTION_TOWER_CLEAR_FLOOR = 1737	-- 家族无尽远征 历史挑战层数
PLAYER_INT_FIELD_FACTION_TOWER_FLAG = 1738	-- 0 扫荡状态 1~15 宝箱领取状态
PLAYER_INT_FIELD_QUALIFY_SCORE = 1739	--  排位赛积分
PLAYER_INT_FIELD_FACTION_SKILL_LV_START = 1740	-- 家族技能等级开始 0:已学习等级 uint16 1:当前生效等级
PLAYER_INT_FIELD_FACTION_SKILL_LV_END = 1760	-- 家族技能等级结束
PLAYER_INT_FIELD_APPEARANCE = 1760	--  外观(0:武器,1:衣服)
PLAYER_INT_FIELD_WEAPON_FORCE = 1761	--  武器外观战力
PLAYER_INT_FIELD_CLOTH_FORCE = 1762	--  衣服外观战力
PLAYER_INT_FIELD_POKEDEX_FORCE = 1763	--  图鉴战力
PLAYER_INT_FIELD_TITLE_FORCE = 1764	--  称号战力
PLAYER_INT_FIELD_RENAME_TIMES = 1765	--  改名次数
PLAYER_INT_FIELD_REVENGE_TIMES = 1766	-- 当日剩余复仇次数
PLAYER_INT_FIELD_REVENGE_BUY_TIMES = 1767	-- 当日复仇购买次数
PLAYER_INT_FIELD_WINGS_STAR = 1768	-- 神羽星数
PLAYER_INT_FIELD_VIPGIFT_FLAG = 1769	-- vip礼包购买状态
PLAYER_APPD_INT_FIELD_CONSUME_SUM = 1770	-- 累计消费元宝
PLAYER_APPD_INT_FIELD_MONEYTREE_COUNT = 1771	-- 摇钱树摇钱次数
PLAYER_APPD_INT_FIELD_MONEYTREE_GIFT_FLAG = 1772	-- 摇钱树礼包领取状态
PLAYER_INT_FIELD_WORLD_RISK_LAST_ID = 1773	-- 最后一次进入的幻境地图id
PLAYER_INT_FIELD_LAST_INSTANCE_TYPE = 1774	-- 上次副本子类型
PLAYER_INT_FIELD_LAST_INSTANCE_PARAM = 1775	-- 上次副本额外参数
PLAYER_EXPAND_INT_LAST_IS_RISK = 1776	-- 最后一次进的是幻境
PLAYER_INT_FIELD_RESTORE_POTION_CD = 1777	-- 回复药功能CD
-- ////////////////////////////////////////////////////////////////////////////////////////////////////////
-- 字符串部分
...
SPELL_INT_FIELD_MERIDIAN_CNT_END = 374	--  每天完成次数结束
SPELL_INT_FIELD_EQUIPDEVELOP_START = 374	--  装备培养开始
SPELL_INT_FIELD_EQUIPDEVELOP_END = 454	-- 装备培养结束
SPELL_INT_FIELD_EQUIPDEVELOP_BONUS_LV = 454	--  装备培养奖励等级 0 强化 1 精炼 2 镶嵌
SPELL_INT_FIELD_APPEARANCE_START = 455	--  外观开始
SPELL_INT_FIELD_APPEARANCE_END = 655	--  外观结束
SPELL_INT_FIELD_PLAYER_ACTIVITY_DATA_START = 655	-- 活动玩家数据开始
SPELL_INT_FIELD_PLAYER_ACTIVITY_DATA_END = 1055	-- 活动玩家数据结束
