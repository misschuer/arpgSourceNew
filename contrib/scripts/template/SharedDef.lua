...
GLOBALVALUE_INT_FIELD_MASS_BOSS_END = 312
GLOBALVALUE_INT_FIELD_LOTTERY_RECORD_CURSOR_START = 312	--  抽奖记录游标
GLOBALVALUE_INT_FIELD_LOTTERY_RECORD_CURSOR_END = 322
GLOBALVALUE_INT_FIELD_ACTIVITIES_RUNNING_START = 322	--  活动运行id 开始
GLOBALVALUE_INT_FIELD_ACTIVITIES_RUNNING_END = 352	--  活动运行id 结束
